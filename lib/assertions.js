...
},{"../test/assertions/active-page":2,"../test/assertions/auth-form":3,"../test/assertions/create-market-form":10,"../test/assertions/favorite-markets":11,"../test/assertions/filters":12,"../test/assertions/is-transactions-working":13,"../test/assertions/keywords":14,"../test/assertions/links":15,"../test/assertions/login-account":19,"../test/assertions/login-account-markets":16,"../test/assertions/login-account-positions":17,"../test/assertions/login-account-reports":18,"../test/assertions/market":21,"../test/assertions/market-data-updater":20,"../test/assertions/markets":24,"../test/assertions/markets-header":22,"../test/assertions/markets-totals":23,"../test/assertions/my-markets":26,"../test/assertions/my-markets-summary":25,"../test/assertions/my-reports":28,"../test/assertions/my-reports-summary":27,"../test/assertions/order-cancellation":29,"../test/assertions/pagination":30,"../test/assertions/portfolio":33,"../test/assertions/portfolio-nav-items":31,"../test/assertions/portfolio-totals":32,"../test/assertions/positions-markets":34,"../test/assertions/positions-summary":35,"../test/assertions/reportable-outcomes":36,"../test/assertions/search-sort":37,"../test/assertions/selected-outcome":38,"../test/assertions/selected-user-open-orders-group":39,"../test/assertions/site-header":40,"../test/assertions/trade-commit-lock":41,"../test/assertions/transactions":43,"../test/assertions/transactions-totals":42,"../test/assertions/url":44}],2:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (marketLink) {
	var label = arguments.length <= 1 || arguments[1] === undefined ? 'marketLink' : arguments[1];
...
},{"../../../test/assertions/common/link":7,"chai":undefined}],10:[function(_dereq_,module,exports){
'use strict';
...
},{"../../test/assertions/common/formatted-date":4,"../../test/assertions/common/formatted-number":5,"../../test/assertions/common/initial-fair-prices":6,"chai":undefined}],11:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (links) {
	describe('augur-ui-react-components links state', function () {
		...
		it('balancesLink', function () {
			(0, _link2.default)(links.balancesLink, 'balancesLink');
		});
...
},{"../../test/assertions/common/link":7,"chai":undefined}],16:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":undefined}],19:[function(_dereq_,module,exports){
'use strict';
...
},{"../../test/assertions/common/formatted-number":5,"chai":undefined}],20:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (market) {
	...
	describe('augur-ui-react-components market state', function () {
		...
		it('market.lastUpdatedBefore', function () {
			_chai.assert.isString(market.lastUpdatedBefore);
		});

		it('market.isUpdateButtonDisabled', function () {
			_chai.assert.isBoolean(market.isUpdateButtonDisabled);
		});
	});
};
...
},{"../../test/assertions/common/formatted-number":5,"../../test/assertions/reportable-outcomes":36,"./common/formatted-date":4,"./common/market-link":8,"chai":undefined}],22:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":undefined}],25:[function(_dereq_,module,exports){
'use strict';
...
},{"./common/formatted-date":4,"./common/formatted-number":5,"./common/market-link":8,"chai":undefined}],27:[function(_dereq_,module,exports){
'use strict';
...
},{"../../test/assertions/common/formatted-number":5,"chai":undefined}],28:[function(_dereq_,module,exports){
'use strict';
...
},{"./common/formatted-date":4,"./common/formatted-number":5,"./common/market-link":8,"chai":undefined}],29:[function(_dereq_,module,exports){
'use strict';
...
},{"./common/nav-item":9,"chai":undefined}],32:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":undefined}],34:[function(_dereq_,module,exports){
'use strict';
...
function assertPosition(position) {
	...
	(0, _formattedNumber2.default)(position.totalValue, 'position.totalValue');
	(0, _formattedNumber2.default)(position.totalCost, 'position.totalCost');
	(0, _formattedNumber2.default)(position.shareChange, 'position.shareChange');
...
},{"./common/formatted-number":5,"./common/market-link":8,"chai":undefined}],35:[function(_dereq_,module,exports){
'use strict';
...
},{"../../test/assertions/common/formatted-number":5,"chai":undefined}],36:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":undefined}],38:[function(_dereq_,module,exports){
'use strict';
...
},{"./active-page":2,"./is-transactions-working":13,"./login-account":19,"./positions-summary":35,"./transactions-totals":42,"chai":undefined}],41:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":undefined}],43:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":undefined}],44:[function(_dereq_,module,exports){
'use strict';
