...
},{"../test/assertions/active-page":2,"../test/assertions/auth-form":3,"../test/assertions/create-market-form":9,"../test/assertions/favorite-markets":10,"../test/assertions/filters":11,"../test/assertions/is-transactions-working":12,"../test/assertions/keywords":13,"../test/assertions/links":14,"../test/assertions/login-account":18,"../test/assertions/login-account-markets":15,"../test/assertions/login-account-positions":16,"../test/assertions/login-account-reports":17,"../test/assertions/market":19,"../test/assertions/markets":22,"../test/assertions/markets-header":20,"../test/assertions/markets-totals":21,"../test/assertions/my-markets":24,"../test/assertions/my-markets-summary":23,"../test/assertions/order-cancellation":25,"../test/assertions/pagination":26,"../test/assertions/portfolio":29,"../test/assertions/portfolio-nav-items":27,"../test/assertions/portfolio-totals":28,"../test/assertions/positions-markets":30,"../test/assertions/positions-summary":31,"../test/assertions/search-sort":32,"../test/assertions/selected-outcome":33,"../test/assertions/selected-user-open-orders-group":34,"../test/assertions/site-header":35,"../test/assertions/transactions":37,"../test/assertions/transactions-totals":36,"../test/assertions/url":38}],2:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (loginAccountMarkets) {
	describe('augur-ui-react-components loginAccountMarket\'s shape', function () {
		_chai.assert.isDefined(loginAccountMarkets);
		_chai.assert.isArray(loginAccountMarkets);

		loginAccountMarkets.forEach(function (report) {
			assertLoginAccountMarkets(report);
		});
	});
};

exports.assertLoginAccountMarkets = assertLoginAccountMarkets;
...
function assertLoginAccountMarkets(report) {
...
},{"../../test/assertions/common/formatted-date":4,"../../test/assertions/common/formatted-number":5,"chai":undefined}],18:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (market) {
	...
	describe('augur-ui-react-components market state', function () {
		...
		xit('market.creationTime', function () {
		...
		xit('market.outstandingShares', function () {
...
},{"./common/nav-item":8,"chai":undefined}],28:[function(_dereq_,module,exports){
'use strict';
...
function assertOutcome(outcome) {
	...
	(0, _formattedNumber2.default)(outcome.lastPrice);
	assertPosition(outcome.position);
}

function assertPosition(position) {
	(0, _formattedNumber2.default)(position.numPositions);
	(0, _formattedNumber2.default)(position.qtyShares);
	(0, _formattedNumber2.default)(position.purchasePrice);
	(0, _formattedNumber2.default)(position.totalValue);
	(0, _formattedNumber2.default)(position.totalCost);
	(0, _formattedNumber2.default)(position.shareChange);
	(0, _formattedNumber2.default)(position.gainPercent);
	(0, _formattedNumber2.default)(position.netChange);
}
...
exports.default = function (positionsSummary) {
	...
	(0, _formattedNumber2.default)(positionsSummary.gainPercent);

	(0, _formattedNumber2.default)(positionsSummary.netChange, 'netChange');
	(0, _formattedNumber2.default)(positionsSummary.numPositions, 'numPositions');
	(0, _formattedNumber2.default)(positionsSummary.purchasePrice, 'purchasePrice');
	(0, _formattedNumber2.default)(positionsSummary.qtyShares, 'qtyShares');
	(0, _formattedNumber2.default)(positionsSummary.shareChange, 'shareChange');
	(0, _formattedNumber2.default)(positionsSummary.totalCost, 'totalCost');
	(0, _formattedNumber2.default)(positionsSummary.totalValue, 'totalValue');
};
...
},{"./active-page":2,"./is-transactions-working":12,"./login-account":18,"./positions-summary":31,"./transactions-totals":36,"chai":undefined}],36:[function(_dereq_,module,exports){
'use strict';
