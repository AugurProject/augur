...
exports.seed = async (knex: Knex): Promise<any> => {
  ...
  return knex("markets").del().then(async (): Promise<any> => {
    ...
    const seedData = [{
      ...
      endTime: 1506573470,
      shortDescription: "This is a categorical test market created by b0b.~|>a|b|c|d|e|f|g|h",
      ...
      reportingWindow: "0x1000000000000000000000000000000000000000",
      endTime: 1507573470,
      shortDescription: "This is a categorical (8) test market created by b0b awaiting round 1 reporting.~|>a|b|c|d|e|f|g|h",
      designatedReporter: "0x0000000000000000000000000000000000000b0b",
      designatedReportStake: "10",
      resolutionSource: "http://www.trusted-third-party.com",
      numTicks: 24,
      ...
      reportingWindow: "0x1000000000000000000000000000000000000000",
      endTime: 1507573470,
      shortDescription: "creator b0b, 4 outcomes in designated reporting state.~|>a|b|c|d",
      designatedReporter: "0x0000000000000000000000000000000000000b0b",
      designatedReportStake: "10",
      resolutionSource: "http://www.trusted-third-party.com",
      numTicks: 94,
      ...
      reportingWindow: "0x1000000000000000000000000000000000000000",
      endTime: 1507573470,
      shortDescription: "creator b0b, 7 outcomes, in designated reporting.~|>a|b|c|d|e|f|g",
      designatedReporter: "0x0000000000000000000000000000000000000b0b",
      designatedReportStake: "10",
      resolutionSource: "http://www.trusted-third-party.com",
      numTicks: 949,
      ...
      reportingWindow: "0x1000000000000000000000000000000000000000",
      endTime: 1507573470,
      shortDescription: "creator b0b, 7 outcomes, round 1 reporting.~|>a|b|c|d|e|f|g",
      designatedReporter: "0x0000000000000000000000000000000000000b0b",
      designatedReportStake: "10",
      resolutionSource: "http://www.trusted-third-party.com",
      numTicks: 949,
      ...
      reportingWindow: "0x1000000000000000000000000000000000000000",
      endTime: 1507573470,
      shortDescription: "creator b0b 5 outcomes, market finalized.~|>a|b|c|d|e",
      designatedReporter: "0x0000000000000000000000000000000000000b0b",
      designatedReportStake: "10",
      resolutionSource: "http://www.trusted-third-party.com",
      numTicks: 949,
