...
export function formatNumber(num, opts = { decimals: 0, decimalsRounded: 0, denomination: '', roundUp: false, roundDown: true, positiveSign: false, zeroStyled: true, minimized: false }) {
