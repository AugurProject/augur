...
export function denormalizePrice(minPrice: string|number, maxPrice: string|number, normalizedPrice: string|number): string {
  ...
  return bnNormalizedPrice.times(bnMaxPrice.minus(bnMinPrice)).plus(bnMinPrice).toFixed();
}
