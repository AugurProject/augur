...
export function getReportingHistory(db: SqlLiteDb, account: Address, market: Address|null, universe: Address|null, reportingWindow: Address|null, callback: (err?: Error|null, result?: any) => void) {
