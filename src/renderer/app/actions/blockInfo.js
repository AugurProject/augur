export const UPDATE_GETH_BLOCK_INFO = 'UPDATE_GETH_BLOCK_INFO'
export const CLEAR_GETH_BLOCK_INFO = 'CLEAR_GETH_BLOCK_INFO'
export const UPDATE_AUGUR_NODE_BLOCK_INFO = 'UPDATE_AUGUR_NODE_BLOCK_INFO'
export const CLEAR_AUGUR_NODE_BLOCK_INFO = 'CLEAR_AUGUR_NODE_BLOCK_INFO'
