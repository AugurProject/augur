...
loginAccount.displayName = loginAccount.handle || loginAccount.linkText;

loginAccount.editHandle = (handle) => {
	loginAccount.handle = (handle && handle !== '') ? handle : undefined;
};

loginAccount.editEmail = (email) => {
	loginAccount.email = (email && email !== '') ? email : undefined;
};
