...
export function getReportingHistory(db: Knex, account: Address, market: Address|null, universe: Address|null, reportingWindow: Address|null, callback: (err?: Error|null, result?: any) => void): void {
