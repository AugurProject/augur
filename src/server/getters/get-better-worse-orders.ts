...
export function getBetterWorseOrders(db: Knex, marketID: Address, outcome: number, amount: string, normalizedPrice: string, callback: (err?: Error|null, result?: any) => void): void {
