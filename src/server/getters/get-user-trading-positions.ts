...
export function getUserTradingPositions(db: Database, account: Address, market: Address|null, outcome: number|null, callback: (err?: Error|null, result?: any) => void): void {
