...
export function getUserTradingHistory(db: Database, account: Address, market: Address|null, outcome: number|null, orderType: string|null, callback: (err?: Error|null, result?: any) => void): void {
