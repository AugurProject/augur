...
export function processWinningsRedeemedLog(db: Knex, augur: Augur, log: FormattedEventLog, callback: ErrorCallback): void {
  console.log("TODO: WinningsRedeemed");
  console.log(log);
  callback(null);
}

export function processWinningsRedeemedLogRemoval(db: Knex, augur: Augur, log: FormattedEventLog, callback: ErrorCallback): void {
