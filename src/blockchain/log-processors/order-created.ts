...
export async function processOrderCreatedLog(db: Knex, augur: Augur, log: FormattedEventLog) {
...
export async function processOrderCreatedLogRemoval(db: Knex, augur: Augur, log: FormattedEventLog) {
