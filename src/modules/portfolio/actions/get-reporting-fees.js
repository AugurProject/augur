  ...
  augur.augurNode.submitRequest(
    'getReportingFees',
    {
      ...
      dispatch(updateReportingWindowStats({
        reportingFees: {
          unclaimedEth: formatAttoEth(result.total.unclaimedEth, { decimalsRounded: 4, zeroStyled: true }),
          unclaimedRep: formatAttoRep(unclaimedRepTotal, { decimalsRounded: 4, zeroStyled: true }),
          unclaimedForkEth: formatAttoEth(result.total.unclaimedForkEth, { decimalsRounded: 4, zeroStyled: true }),
          unclaimedForkRepStaked: formatAttoRep(result.total.unclaimedForkRepStaked, { decimalsRounded: 4, zeroStyled: true }),
