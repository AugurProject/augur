...
export default class PortfolioReports extends Component {
  ...
  render() {
    ...
    if ((isNaN(reportingFees.unclaimedEth.formatted) || reportingFees.unclaimedEth.formatted === '') && (isNaN(reportingFees.unclaimedRep.formatted) || reportingFees.unclaimedRep.formatted === '')) {
