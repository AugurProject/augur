...
const PortfolioReportsForkedMarketCard = ({ buttonAction, currentTimestamp, forkedMarketReportingFeesInfo, linkType, market, unclaimedForkEth, unclaimedForkRep, updateModal }) => {
