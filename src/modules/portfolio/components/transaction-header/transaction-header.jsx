  ...
  return (
    <div>
      ...
      <h3 className={Styles.TransactionHeader__message}>
        ...
        { transaction && transaction.transactions && transaction.transactions.length === 1 && transaction.transactions[0].meta && transaction.transactions[0].meta.canceledTransactionHash &&
