    ...
    return (
      <section className={Styles.ModalDisclaimer}>
        ...
        <div className={Styles.ModalDisclaimer__ActionButtons}>
          ...
          <button
            disabled={!s.didScroll || !s.didCheck}
