  ...
  render() {
    ...
    return (
      <section className={Styles.ModalDisclaimer}>
        ...
        >
          <p>Augur is a decentralized oracle and peer to peer Protocol for prediction markets. Augur is free, public, open source software and a set of smart contracts written in Solidity that can be deployed to the Ethereum blockchain (the “<b>Augur Protocol</b>”). Before using the Augur Protocol, please review the <a href="augur.net/faq">FAQs</a> and <a href="docs.augur.net">documentation</a> (the “<b>Documentation</b>”) for a detailed explanation on how the Augur Protocol works.</p>
