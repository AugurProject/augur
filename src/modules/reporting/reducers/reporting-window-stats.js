...
const DEFAULT_STATE = {
  ...
  stake: null,
  reportingFees: {
    unclaimedEth: formatAttoEth(0, { decimalsRounded: 4, zeroStyled: true }),
    unclaimedRep: formatAttoRep(0, { decimalsRounded: 4, zeroStyled: true }),
    unclaimedForkEth: formatAttoEth(0, { decimalsRounded: 4, zeroStyled: true }),
    unclaimedForkRepStaked: formatAttoRep(0, { decimalsRounded: 4, zeroStyled: true }),
    feeWindows: [],
    forkedMarket: null,
    nonforkedMarkets: [],
  },
