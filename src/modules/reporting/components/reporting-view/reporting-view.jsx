...
const ReportingView = p => (
  <section>
    <Switch>
      <Route path={makePath(REPORTING_DISPUTE_MARKETS)} component={ReportingDisputeMarkets} />
      <Route path={makePath(REPORTING_REPORT_MARKETS)} component={ReportingReportMarkets} />
      <Route path={makePath(REPORTING_RESOLVED_MARKETS)} component={ReportingResolved} />
    </Switch>
  </section>
)
