...
export function processShortSellRisky(transactionID, marketID, outcomeID, numShares, limitPrice) {
	return (dispatch, getState) => {
		...
		shortSellRisky(transactionID, marketID, outcomeID, limitPrice, numShares, (err, res) => {
			if (err) {
...
function shortSellRisky(transactionID, marketID, outcomeID, limitPrice, totalShares, cb) {
	augur.buyCompleteSetsThenSell({
		...
		onSent: data => console.log('shortSellRisky onSent', data),
		onFailed: cb,
