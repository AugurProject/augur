  ...
  return (dispatch, getState) => {
    ...
    if (newTradeDetails.side && newTradeDetails.numShares && loginAccount.address) {
      dispatch(loadAccountPositions({ market: marketId }, (err, accountPositions) => {
        ...
        const estimatedGasCost = formatGasCostToEther(createBigNumber(simulatedTrade.gasEstimate || augur.constants.TRADE_GAS, 10), { decimalsRounded: 4 }, createBigNumber(augur.rpc.getGasPrice(), 10))
