...
import { SEARCH_PARAM_NAME, FILTER_SORT_TYPE_PARAM_NAME, FILTER_SORT_SORT_PARAM_NAME, FILTER_SORT_ISDESC_PARAM_NAME, PAGE_PARAM_NAME, TAGS_PARAM_NAME, FILTERS_PARAM_NAME } from '../../link/constants/param-names';
...
export default function () {
	const { keywords, selectedFilters, selectedFilterSort, selectedTags, pagination, loginAccount, auth, loginMessage } = store.getState();
	...
	return {
		...
		marketsLink: selectMarketsLink(keywords, selectedFilters, selectedFilterSort, selectedTags, pagination.selectedPageNum, store.dispatch),
...
export const selectMarketsLink = memoizerific(1)((keywords, selectedFilters, selectedFilterSort, selectedTags, selectedPageNum, dispatch) => {
	const params = {};
