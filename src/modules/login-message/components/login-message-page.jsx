		...
		<article className="page-content">
			<div className="l-container">
				...
				<p>This is a BETA TEST in advance of the Augur Project’s V1 launch. There are bugs. There are
					...
					every page
					to submit your feedback, or feel free to send an email to: hugs@augur.net (^^add subject: "Beta
					Testing
					feedback" )
				...
				<ol>
					<li>
						...
						is impossible
						to recover them. Please take appropriate measures to protect the safety of your password,
						and create a
						way to recover your credentials if you forget them. (^^add link to the FAQ once input into
						Zendesk, see
						below)
					</li>
					<li>
					...
					<li>
						...
						Learn <a href="https://www.youtube.com/watch?v=sCms-snzHk4">How Augur's Reputation Tokens
						Work</a>
					</li>
					<li>
				...
				<p className="strong">Beta Test System Status:</p>
