...
<<<<<<< HEAD
			<h3>Decembter 21, 2016</h3>
			<ol>
				<li>
					Fixed reported outcome processing in event logs in augur.js.
				</li>
				<li>
					Fixed report outcome processing in converted transactions.
				</li>
				<li>
			...
			<ol>
				...
				<li>
					The account trades loader now also pulls a full set of other transaction logs.
				</li>
				<li>
				...
				<li>
					Added a generic getLogs method to augur.js.  getLogs takes the event name as an argument, and supports nested indexing.
				</li>
				<li>
					The augur.js filters module has custom event parsing for all (non-logReturn) logged events.
				</li>
			</ol>
			<h3>Decembter 19, 2016</h3>
			<ol>
				<li>
