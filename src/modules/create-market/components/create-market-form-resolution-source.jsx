...
export default class CreateMarketFormResolutionSource extends Component {
  constructor(props) {
    super(props);
...
CreateMarketFormResolutionSource.propTypes = {
  description: PropTypes.string,
  updateValidity: PropTypes.func.isRequired,
  updateNewMarket: PropTypes.func.isRequired
};

CreateMarketFormResolutionSource.defaultProps = {
  description: ''
};
