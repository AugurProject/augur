...
export const AugurLoadingLogo = Styles => (
  <svg viewBox="0 0 306 306">
    <path className={Styles.outerLines} d="M66.3 199.1L152.8 55M152.8 251l-86.5-51.9M239.7 199.1L152.8 251M152.8 55l86.9 144.1" />
    <path className={Styles.innerBottomLine} d="M152.8 250.5l.3-33.8c0-6.3 3.4-12.1 9-15.2l5.6-2.8c6-3 11.1-7.7 14.5-13.6l2.2-3.7" />
    <path className={Styles.innerLines} d="M158.1 135.2s13.6 3.1 20.2 11c11.3 13.5 6.3 25.5 13.7 30.7 8.5 6 46.4 22.2 46.4 22.2m-118.7-30.8s.2-9.8 5.9-18.5c6.9-10.5 18-12.4 23.5-17.8 4.5-4.4 4-13 4-13l-.3-62.5m-4 144.5s-7.8-1-13.4-4.7c-7.3-4.9-12.5-15.1-17.6-17.1-5.5-2.1-11.4 1-11.4 1L66.3 199" />
    <path className={Styles.mask} d="M183.1 170.7s2.5 9 7.5 12.8c5 3.8-1.9 6.4-8.1.9s.6-13.7.6-13.7zm-22.2-33.9c4.5-6.9.9-13.4-2.1-7.8-3 5.5-11.5 9.4-11.5 9.4s9.1 5.4 13.6-1.6zm-41.5 29.4c-8.1-1.8-12.8 3.9-6.6 4.7s12.9 7.4 12.9 7.4 1.8-10.3-6.3-12.1zm34.6 36.4c3.3-7.5-1.3-13.3-3.4-7.4-2.1 6-9.8 11.2-9.8 11.2s9.9 3.8 13.2-3.8z" />
  </svg>
)
