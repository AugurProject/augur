...
- getSimulatedBuy(market, outcome, amount[, callback])
    ...
    ```javascript
    > Augur.getSimulatedBuy("0xb13d98f933cbd602a3d9d4626260077678ab210d1e63b3108b231c1758ff9971", 1, constants.ONE.toString(16))
...
- getSimulatedSell(market, outcome, amount[, callback])
    ...
    ```javascript
    > Augur.getSimulatedSell("0xb13d98f933cbd602a3d9d4626260077678ab210d1e63b3108b231c1758ff9971", 1, constants.ONE.toString(16))
...
- price(market, outcome[, callback]): Get the current (instantaneous) price of an outcome.
    ...
    ```javascript
    > Augur.price(market_id, 1, function (r) { console.log(r.dividedBy(constants.ONE).toFixed()); })
