...
geth --fast $optargs --cache 2048 --networkid $network --wsorigins "*" --ws --wsapi "eth,net,web3" --wsport 8546 --rpc --rpcapi "eth,net,web3" --rpccorsdomain "*" --maxpeers $maxpeers --etherbase $address --unlock $address console
