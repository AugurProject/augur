...
export type ApiFunctionWithCallback = (p: ApiParams, callback: ApiCallback) => void;
export type ApiFunctionWithoutCallback = (p: ApiParams) => Promise<any>;
export type ApiFunction = ApiFunctionWithCallback | ApiFunctionWithoutCallback;
