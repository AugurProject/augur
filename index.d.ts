...
export type GetGasPriceFunction = (callback: (err: Error|null, gasPrice: number) => void) => void;
...
export class Augur {
  ...
  public setGasPriceFunction(gasPriceFunction: GetGasPriceFunction|undefined): void;
  public getGasPrice: GetGasPriceFunction|undefined;
}
