...
describe(`modules/reports/helpers/progress-calculations.js`, () => {
  ...
  test(`add REP stake get percentage`, () => {
    expect(calculateAddedStakePercentage(createBigNumber("10", 10), 0, 1)).toEqual(10);
  });

  test(`add REP stake get percentage`, () => {
    expect(calculateAddedStakePercentage(
