...
const shouldPushProtectedBranches = process.env.PUSH_PROTECTED_BRANCHES === 'true';
...
const confirmPushIfOnMaster = () => getCurrentGitBranchName()
  .then((branchName) => {
    if (!PROTECTED_BRANCHES.includes(branchName) || shouldPushProtectedBranches) return;
    shell.echo([
