...
if(!process.env.CURRENT_COMMITHASH || !process.env.CURRENT_VERSION || !process.env.CURRENT_BRANCH) {
  ...
  process.env.CURRENT_BRANCH = process.env.CURRENT_BRANCH || gitRevisionPlugin.branch();
}
