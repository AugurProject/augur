...
import NewQuadBox, {
  NewQuadBoxProps,
} from 'modules/portfolio/components/common/new-quad-box';

export interface NewFilterBoxProps extends NewQuadBoxProps {
...
NewFilterBox.defaultProps = {
  emptyDisplayIcon: StarIcon,
};

export default NewFilterBox;
