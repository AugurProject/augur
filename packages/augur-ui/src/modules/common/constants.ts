...
export const CLAIM_MARKETS_PROCEEDS_GAS_ESTIMATE = createBigNumber(1941271); // Gas cost for claiming proceeds from a categorical market with 8 outcomes (worst-case gas cost)
