...
export const ReportingRadioBarGroup = ({
  ...
  if (market.isForking) {
    subheaderText =
      'Once chosen you will be asked to migrate all your REP across to this outcome’s new universe. Please be aware that migrating REP is a one way operation and once migrated you can not move your REP to another universe generated by the other outcomes of this Fork.';
