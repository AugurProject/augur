...
import { MODAL_CLAIM_PARTICIPATION_TOKENS, MODAL_PARTICIPATE, ZERO } from 'modules/common/constants';
...
const mapDispatchToProps = dispatch => ({
  ...
  openClaimParticipationTokensModal: () => dispatch(updateModal({type: MODAL_CLAIM_PARTICIPATION_TOKENS}))
});
