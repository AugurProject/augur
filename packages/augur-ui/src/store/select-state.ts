...
export const selectAccountPositionsState = (state:State) => state.accountPositions;
...
export const selectEdgeContextState = (state:State) => state.authStatus.edgeContext;
export const selectEdgeLoadingState = (state:State) => state.authStatus.edgeLoading;
...
export const selectReportingWindowStats = (state:State) => state.reportingWindowStats;
...
export const selectIsMobileSmall = (state:State) => state.appStatus.isMobileSmall;
export const selectLoginAccountState = (state:State) => state.loginAccount;
export const selectLoginAccountTotalsState = (state:State) =>
  state.loginAccount.tradingPositionsTotal;
export const selectMarketReportState = (state:State) => state.marketReportState;
export const selectMarketsDataState = (state:State) => state.marketsData;
export const selectMarketsFilteredSorted = (state:State) => state.marketsFilteredSorted;
...
export const selectReadNotificationState = (state:State) => state.readNotifications;
...
export const selectOrderCancellationState = (state:State) => state.orderCancellation;
...
export const selectSmallestPositionsState = (state:State) => state.smallestPositions;
...
export const selectAccountShareBalance = (state:State) => state.accountShareBalances;
