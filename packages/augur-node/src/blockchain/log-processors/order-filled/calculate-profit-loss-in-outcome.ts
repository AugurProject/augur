...
import { getTradingHistory } from "../../../server/getters/get-trading-history";
...
export function calculateProfitLossInOutcome(db: Knex, augur: Augur, account: Address, marketId: Address, outcome: number, callback: (err: (Error|null), profitLossInOutcome?: CalculatedProfitLoss) => void): void {
  getTradingHistory(db, null, account, marketId, outcome, null, null, null, null, null, null, null, true, (err: Error|null, userTradingHistory?: Array<UITrade>): void => {
