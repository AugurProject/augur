...
(function (SUBSCRIPTION_EVENT_NAMES) {
  ...
  SUBSCRIPTION_EVENT_NAMES.DISPUTE_WINDOW_CLOSED = "DisputeWindowClosed";
  SUBSCRIPTION_EVENT_NAMES.DISPUTE_WINDOW_CREATED = "DisputeWindowCreated";
  SUBSCRIPTION_EVENT_NAMES.DISPUTE_WINDOW_OPENED = "DisputeWindowOpened";
  SUBSCRIPTION_EVENT_NAMES.DISPUTE_WINDOW_REDEEMED = "DisputeWindowRedeemed";
