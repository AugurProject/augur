...
contract ISideChainAugurTrading {
    ...
    function logOrderCanceled(IUniverse _universe, address _market, address _creator, uint256 _tokenRefund, uint256 _sharesRefund, bytes32 _orderId) public returns (bool);
