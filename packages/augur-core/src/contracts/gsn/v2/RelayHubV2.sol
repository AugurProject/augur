...
contract RelayHubV2 is IRelayHub {
    ...
    string public versionHub = "2.0.0-alpha.1+opengsn.hub.irelayhub";
    ...
    */
    ...
    returns (bool paymasterAccepted, string memory revertReason)
    {
        ...
        (vars.success, vars.recipientContext, vars.gasLimits) = this.canRelay(relayRequest, externalGasLimit, signature, approvalData);
