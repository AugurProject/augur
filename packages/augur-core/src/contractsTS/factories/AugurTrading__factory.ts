...
import type { AugurTrading } from "../AugurTrading";

export class AugurTrading__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AugurTrading {
    return new Contract(address, _abi, signerOrProvider) as AugurTrading;
  }
}
...
const _abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: true,
        internalType: "enum AugurTrading.OrderEventType",
        name: "eventType",
        type: "uint8",
      },
      {
