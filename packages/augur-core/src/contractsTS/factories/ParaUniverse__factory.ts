...
import type { ParaUniverse } from "../ParaUniverse";

export class ParaUniverse__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ParaUniverse {
    return new Contract(address, _abi, signerOrProvider) as ParaUniverse;
  }
}
...
const _abi = [
  ...
  },
  {
    constant: true,
    inputs: [],
    name: "currentReportingFeeDivisor",
    outputs: [
      {
  ...
  },
  {
    constant: true,
    inputs: [],
    name: "lastReportingFeeUpdateTimestamp",
    outputs: [
      {
        internalType: "uint256",
        name: "",
