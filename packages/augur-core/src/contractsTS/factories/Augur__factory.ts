...
import type { Augur } from "../Augur";

export class Augur__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): Augur {
    return new Contract(address, _abi, signerOrProvider) as Augur;
  }
}
