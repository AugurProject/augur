...
import type { DevUtils } from "../DevUtils";

export class DevUtils__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DevUtils {
    return new Contract(address, _abi, signerOrProvider) as DevUtils;
  }
}
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType:
          "enum OrderTransferSimulationUtils.OrderTransferResults[]",
        name: "orderTransferResults",
        type: "uint8[]",
      },
    ],
