...
import type { HotLoadingUniversal } from "../HotLoadingUniversal";

export class HotLoadingUniversal__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HotLoadingUniversal {
    return new Contract(address, _abi, signerOrProvider) as HotLoadingUniversal;
  }
}
