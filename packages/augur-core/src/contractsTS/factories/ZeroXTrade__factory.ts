...
import type { ZeroXTrade } from "../ZeroXTrade";

export class ZeroXTrade__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ZeroXTrade {
    return new Contract(address, _abi, signerOrProvider) as ZeroXTrade;
  }
}
...
const _abi = [
  ...
  },
  {
    ...
    name: "estimateProtocolFeeCostInCash",
    outputs: [
      {
        internalType: "uint256",
        name: "",
