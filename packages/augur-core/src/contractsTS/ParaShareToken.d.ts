...
interface ParaShareTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "approveUniverse(address)": FunctionFragment;
    ...
    "divideUpWinnings(address,address,uint256,uint256)": FunctionFragment;
    ...
    "isMarketInitialized(address)": FunctionFragment;
    "lowestBalanceOfMarketOutcomes(address,uint256[],address)": FunctionFragment;
    "name()": FunctionFragment;
    "originalShareToken()": FunctionFragment;
    ...
    "sellCompleteSets(address,address,address,uint256,bytes32)": FunctionFragment;
    "sellCompleteSetsForTrade(address,uint256,uint256,address,address,address,address,uint256,address,bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "approveUniverse",
    values: [string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "isMarketInitialized",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "originalShareToken",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ParaShareToken extends Contract {
  ...
  interface: ParaShareTokenInterface;
  ...
  functions: {
    ...
    "divideUpWinnings(address,address,uint256,uint256)"(
      _market: string,
      _paraUniverse: string,
      _outcome: BigNumberish,
      _numberOfShares: BigNumberish,
    ...
    originalShareToken(overrides?: CallOverrides): Promise<[string]>;
    ...
    "sellCompleteSets(address,address,address,uint256,bytes32)"(
      _market: string,
      _holder: string,
      _recipient: string,
      _amount: BigNumberish,
    ...
    "sellCompleteSetsForTrade(address,uint256,uint256,address,address,address,address,uint256,address,bytes32)"(
      _market: string,
      _outcome: BigNumberish,
      _amount: BigNumberish,
      _shortParticipant: string,
  ...
  callStatic: {
    ...
    initializeMarket(_market: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    originalShareToken(overrides?: CallOverrides): Promise<BigNumber>;
