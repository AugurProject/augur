...
interface ParaZeroXTradeInterface extends ethers.utils.Interface {
  functions: {
...
export class ParaZeroXTrade extends Contract {
  ...
  interface: ParaZeroXTradeInterface;
