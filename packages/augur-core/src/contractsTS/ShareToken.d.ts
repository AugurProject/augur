...
interface ShareTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "assertBalances(address)": FunctionFragment;
    ...
    "initializeMarket(address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "assertBalances",
    values: [string]
  ): string;
...
export class ShareToken extends Contract {
  ...
  functions: {
    ...
    assertBalances(_market: string, overrides?: CallOverrides): Promise<[void]>;

    "assertBalances(address)"(
      _market: string,
      overrides?: CallOverrides
    ): Promise<[void]>;
    ...
    "initializeMarket(address,uint256,uint256)"(
      _market: string,
      _numOutcomes: BigNumberish,
      _numTicks: BigNumberish,
      overrides?: Overrides
