...
interface ZeroXTradeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "estimateProtocolFeeCostInCash(uint256,uint256)": FunctionFragment;
    ...
    "isOrderAmountValid(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "estimateProtocolFeeCostInCash",
  ...
  encodeFunctionData(
    functionFragment: "isOrderAmountValid",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export class ZeroXTrade extends Contract {
  ...
  functions: {
    ...
    estimateProtocolFeeCostInCash(
      _numOrders: BigNumberish,
      _gasPrice: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    "estimateProtocolFeeCostInCash(uint256,uint256)"(
      _numOrders: BigNumberish,
      _gasPrice: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    "isOrderAmountValid(address,uint256)"(
      _market: string,
      _orderAmount: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean]>;
