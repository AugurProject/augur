...
interface SideChainFillOrderInterface extends ethers.utils.Interface {
  functions: {
    "augur()": FunctionFragment;
    "augurTrading()": FunctionFragment;
    "fillZeroXOrder(address,uint256,uint256,uint8,address,uint256,bytes32,address)": FunctionFragment;
...
export class SideChainFillOrder extends Contract {
  ...
  interface: SideChainFillOrderInterface;
  ...
  functions: {
    ...
    "fillZeroXOrder(address,uint256,uint256,uint8,address,uint256,bytes32,address)"(
      _market: string,
      _outcome: BigNumberish,
      _price: BigNumberish,
      _orderType: BigNumberish,
