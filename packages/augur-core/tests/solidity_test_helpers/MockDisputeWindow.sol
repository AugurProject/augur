...
contract MockDisputeWindow is Initializable, MockVariableSupplyToken, IDisputeWindow {
    ...
    * Impl of IDisputeWindow and ITyped
    ...
    function createMarket(uint256 _endTime, uint256 _feePerCashInAttoCash, ICash _denominationToken, address _designatedReporterAddress, address _sender, uint256 _numOutcomes, uint256 _numTicks) public returns (IMarket _newMarket) {
        return market;
    }
