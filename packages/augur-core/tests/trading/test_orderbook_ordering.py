...
def test_correct_order_for_same_price(contractsFixture, cash, market):
    ...
    with BuyWithCash(cash, fix('1', '3001'), tester.k1, "create order 1"):
        orderID1 = createOrder.publicCreateOrder(BID, fix(1), 3001, market.address, YES, longTo32Bytes(0), longTo32Bytes(0), tradeGroupID, False, sender = tester.k1)
    with BuyWithCash(cash, fix('1', '3000'), tester.k1, "create order 2"):
        orderID2 = createOrder.publicCreateOrder(BID, fix(1), 3000, market.address, YES, longTo32Bytes(0), longTo32Bytes(0), tradeGroupID, False, sender = tester.k1)
    with BuyWithCash(cash, fix('2', '3000'), tester.k1, "create order 3"):
        orderID3 = createOrder.publicCreateOrder(BID, fix(2), 3000, market.address, YES, longTo32Bytes(0), longTo32Bytes(0), tradeGroupID, False, sender = tester.k1)
    with BuyWithCash(cash, fix('3', '3000'), tester.k1, "create order 4"):
        orderID4 = createOrder.publicCreateOrder(BID, fix(3), 3000, market.address, YES, longTo32Bytes(0), longTo32Bytes(0), tradeGroupID, False, sender = tester.k1)
    with BuyWithCash(cash, fix('1', '2999'), tester.k1, "create order 5"):
        orderID5 = createOrder.publicCreateOrder(BID, fix(1), 2999, market.address, YES, longTo32Bytes(0), longTo32Bytes(0), tradeGroupID, False, sender = tester.k1)
    with BuyWithCash(cash, fix('4', '3000'), tester.k1, "create order 6"):
        orderID6 = createOrder.publicCreateOrder(BID, fix(4), 3000, market.address, YES, longTo32Bytes(0), longTo32Bytes(0), tradeGroupID, False, sender = tester.k1)
