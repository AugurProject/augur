...
def test_publicCreateOrder_List_Logic(contractsFixture, cash, market):
    ...
    with BuyWithCash(cash, fix(1, 10), contractsFixture.accounts[0], "create order 1"):
        orderID_10 = createOrder.publicCreateOrder(BID, fix(1), 10, market.address, 1, longTo32Bytes(0), longTo32Bytes(0), longTo32Bytes(1))
    with BuyWithCash(cash, fix(1, 8), contractsFixture.accounts[0], "create order 2"):
        orderID_8 = createOrder.publicCreateOrder(BID, fix(1), 8, market.address, 1, longTo32Bytes(0), longTo32Bytes(0), longTo32Bytes(2))
    with BuyWithCash(cash, fix(1, 6), contractsFixture.accounts[0], "create order 3"):
        orderID_6 = createOrder.publicCreateOrder(BID, fix(1), 6, market.address, 1, longTo32Bytes(0), longTo32Bytes(0), longTo32Bytes(3))
    with BuyWithCash(cash, fix(1, 2), contractsFixture.accounts[0], "create order 4"):
        orderID_2 = createOrder.publicCreateOrder(BID, fix(1), 2, market.address, 1, longTo32Bytes(0), longTo32Bytes(0), longTo32Bytes(4))
    with BuyWithCash(cash, fix(1, 1), contractsFixture.accounts[0], "create order 5"):
        orderID_1 = createOrder.publicCreateOrder(BID, fix(1), 1, market.address, 1, longTo32Bytes(0), longTo32Bytes(0), longTo32Bytes(5))
    with BuyWithCash(cash, fix(1, 7), contractsFixture.accounts[0], "create order 6"):
        orderID_7 = createOrder.publicCreateOrder(BID, fix(1), 7, market.address, 1, orderID_10, orderID_1, longTo32Bytes(6))
    assert orderID_7
    ...
    with BuyWithCash(cash, fix(1, 5), contractsFixture.accounts[0], "create order 7"):
        orderID_5 = createOrder.publicCreateOrder(BID, fix(1), 5, market.address, 1, orderID_6, orderID_1, longTo32Bytes(7))
    assert orderID_5
    ...
    with BuyWithCash(cash, fix(1, 3), contractsFixture.accounts[0], "create order 8"):
        orderID_3 = createOrder.publicCreateOrder(BID, fix(1), 3, market.address, 1, orderID_5, orderID_2, longTo32Bytes(8))
    assert orderID_3
...
def test_duplicate_creation_transaction(contractsFixture, cash, market):
    ...
    with raises(TransactionFailed):
        createOrder.publicCreateOrder(BID, fix(1), 40, market.address, 1, longTo32Bytes(0), longTo32Bytes(0), longTo32Bytes(7))
