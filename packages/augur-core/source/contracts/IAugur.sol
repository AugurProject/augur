...
contract IAugur {
    ...
    function logOrderFilled(IUniverse _universe, address _filler, address creator, IMarket _market, bytes32 _orderId, uint256 _marketCreatorFees, uint256 _reporterFees, uint256 _amountFilled, uint256 _outcome, bytes32 _tradeGroupId) public returns (bool);
