...
const augurCorePath = path.join(__dirname, "../../core/");

function makeDeployerConfiguration() {
  const contractInputRoot = path.join(augurCorePath, "../artifacts/src");
  const artifactOutputRoot  = path.join(augurCorePath, "../artifacts/src");
