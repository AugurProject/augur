...
exports.up = async (knex: Knex): Promise<any> => {
  return knex.schema.dropTableIfExists("markets").then((): PromiseLike<any> => {
    return knex.schema.raw(`CREATE TABLE markets (
      ...
      "feeDivisor" VARCHAR(255) NOT NULL,
      ...
      "disputeWindow" varchar(66),
      "endTime" bigint NOT NULL CONSTRAINT positiveEndTime CHECK ("endTime" > 0),
      ...
      "isInvalid" boolean,
      "needsDisavowal" boolean DEFAULT false
    )`)
