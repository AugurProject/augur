[@augurproject/sdk](../README.md) > ["state/logs/types"](../modules/_state_logs_types_.md) > [TimestampSetLog](../interfaces/_state_logs_types_.timestampsetlog.md)
...
* [_id](_state_logs_types_.timestampsetlog.md#_id)
* [_rev](_state_logs_types_.timestampsetlog.md#_rev)
* [blockHash](_state_logs_types_.timestampsetlog.md#blockhash)
* [blockNumber](_state_logs_types_.timestampsetlog.md#blocknumber)
* [logIndex](_state_logs_types_.timestampsetlog.md#logindex)
* [newTimestamp](_state_logs_types_.timestampsetlog.md#newtimestamp)
* [transactionHash](_state_logs_types_.timestampsetlog.md#transactionhash)
* [transactionIndex](_state_logs_types_.timestampsetlog.md#transactionindex)
...
**● newTimestamp**: *[Timestamp](../modules/_state_logs_types_.md#timestamp)*

*Defined in [state/logs/types.ts:234](https://github.com/AugurProject/augur/blob/1991ef64ef/packages/augur-sdk/src/state/logs/types.ts#L234)*
