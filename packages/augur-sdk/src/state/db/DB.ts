...
console.log("#################");
console.error(await this.syncStatus.getLowestSyncingBlockForAllDBs());
console.error(await this.augur.provider.getBlock(await this.syncStatus.getLowestSyncingBlockForAllDBs()));
