  ...
  static async getProfitLossSummary(
    ...
    for (const days of [ONE_DAY, DAYS_IN_MONTH]) {
      ...
      const negativeStartProfit: MarketTradingPosition = {
        ...
        realized: new BigNumber(startProfit.realized).negated().toFixed(4),
        unrealized: new BigNumber(startProfit.unrealized).negated().toFixed(4),
        unrealized24Hr: '0',
        frozenFunds: '0',
        marketId: '',
        total: '0',
...
function getTradingPositionFromProfitLossFrame(
  ...
  return {
    ...
    realized: realizedProfit.toFixed(4),
    unrealized: unrealized.toFixed(4),
    unrealized24Hr: unrealized24Hr.toFixed(),
