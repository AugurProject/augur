...
describe('State API :: Markets :: ', () => {
  ...
  test(':getMarkets', async () => {
    ...
    expect(marketList.filteredOutCount).toEqual(2);
    ...
    expect(marketList.filteredOutCount).toEqual(3);
    ...
    // TODO: Add tests for LastTradedTimestamp & LastTradedTimestamp sorts
  }, 120000);
