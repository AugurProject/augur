...
describe('State API :: Markets :: ', () => {
  ...
  beforeAll(async () => {
    ...
    markets['yesNoMarket1'] = (await john.createYesNoMarket({
      ...
      affiliateFeeDivisor,
      designatedReporter,
      extraInfo: '{"categories": ["common", "yesNo 1 secondary", "yesNo 1 tertiary"], "description": "yesNo description 1", "longDescription": "yesNo longDescription 1", "resolutionSource": "http://www.blah.com"}',
    })).address;
  ...
  test(':getMarkets userPortfolioAddress', async () => {
    ...
    const yesNoMarket1 = await bob.createYesNoMarket({
      ...
      affiliateFeeDivisor,
      designatedReporter,
      extraInfo: '{"categories": ["yesNo 1 primary", "yesNo 1 secondary", "yesNo 1 tertiary"], "description": "yesNo description 1", "longDescription": "yesNo longDescription 1", "resolutionSource": "http://www.blah.com"}',
    });
