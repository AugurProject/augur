  ...
  subscribe(
    ...
    if (params[0] === 'heartbeat') {
      ...
      if (this._subInterval !== null) {
        throw new Error(
          'Attempting to subscribe twice to the mock relayer. Make sure tests unsubscribe.'
        );
      }
      ...
      params: {
        ...
        result: [
          Object.assign(order, {
            kind: 'ADDED',
            txHash:
              '0x9e6830a7044b39e107f410e4f765995fd0d3d69d5c3b3582a1701b9d68167560',
          }),
        ],
      },
    };
