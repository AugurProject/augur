...
import { ContractAPI as ToolsContractAPI, Account } from "@augurproject/tools";

const ETERNAL_APPROVAL_VALUE = new BigNumber("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // 2^256 - 1

export class ContractAPI extends ToolsContractAPI {
  constructor(augur: Augur, provider: EthersProvider, account: Account) {
