...
describe("abi.pad_right", function () {
    var test = function (t) {
        it(t.value + " -> " + t.expected, function () {
            assert.strictEqual(Augur.abi.pad_right(t.value), t.expected);
        });
    };
    test({
        value:    "0",
...
describe("abi.pad_left", function () {
    var test = function (t) {
        it(t.value + " -> " + t.expected, function () {
            assert.strictEqual(Augur.abi.pad_left(t.value), t.expected);
        });
    };
    test({
        value:    "0",
...
describe("abi.chunk", function () {
    var test = function (t) {
        it(t.value + " -> " + t.expected, function () {
            assert.strictEqual(Augur.abi.chunk(t.value), t.expected);
        });
    };
...
describe("abi.offset", function () {
    var test = function (t) {
        it(t.value + " -> " + t.expected, function () {
            assert.strictEqual(Augur.abi.offset(t.len, t.num_params), t.expected);
        });
    };
    test({
        len: 1,
