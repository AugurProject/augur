...
describe("Crypto", function () {
    ...
    //     var privKey = new Buffer("7a28b5ba57c53603b0b07b56bba752f7784bf506fa95edc395f5cf6c7514fe9d", "hex");
    //     var salt = new Buffer("ae3cd4e7013836a3df6bd7241b12db061dbe2c6785853cce422d148a624ce0bd", "hex");
    //     var iv = new Buffer("6087dab2f9fdbbfaddc31a909735c1e6", "hex");
    //     var expected = {
    //         crypto: {
    //             cipher: "aes-128-ctr",
    //             cipherparams: {
    ...
    //         version: 3
    //     };
    //     augur.Crypto.dumpPrivateKey(password, privKey, salt, iv, function (json) {
    //         if (json.error) {
    //             done(json);
    //         } else {
    //             log(json);
