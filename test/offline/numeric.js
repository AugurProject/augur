...
describe("Fixed point tests", function () {
    ...
    describe("unfix", function () {
        it("fixed-point -> hex", function () {
            assert.strictEqual(numeric.unfix(numeric.fix(ex_integer_hex, "BigNumber"), "hex"), ex_integer_hex);
        });
        it("fixed-point -> string", function () {
            assert.strictEqual(numeric.unfix(numeric.fix(ex_integer_string, "BigNumber"), "string"), ex_integer_string);
        });
        it("fixed-point -> number", function () {
            assert.strictEqual(numeric.unfix(numeric.fix(ex_integer_string, "BigNumber"), "number"), ex_integer);
        });
    });
});
