...
const { checkAugurDbSetup } = require("../build/check-augur-db-setup");
const { getAccountTransferHistory } = require("../build/get-account-transfer-history");

const augurDbPath = join(__dirname, "augur.db");

describe("getAccountTransferHistory", () => {
  const test = (t) => {
