...
describe(`modules/my-positions/selectors/my-positions-summary.js`, () => {
  describe('generateOutcomePositionSummary', () => {
    ...
    test({
      description: `should return the expected value when adjusted positions are defined AND position is non-zero, no open orders`,
      assertions: () => {
    ...
    test({
      description: `should return the expected value when adjusted positions are defined AND position is non-zero, With open order`,
      assertions: () => {
        ...
        const actual = generateOutcomePositionSummary([{
          ...
          unmatchedShares: { fullPrecision: '3' },
          type: BUY,
        }])
    ...
    test({
      description: `should return the expected value when adjusted positions are defined AND position is non-zero, With open orders`,
      assertions: () => {
        ...
        const actual = generateOutcomePositionSummary([{
          ...
          unmatchedShares: { fullPrecision: '5' },
          type: SELL,
        }])
    ...
    test({
      description: `should return the expected value when adjusted positions are defined AND position is non-zero, With open orders complex`,
      assertions: () => {
        ...
        {
          unmatchedShares: { fullPrecision: '2' },
          type: SELL,
        },
        {
          unmatchedShares: { fullPrecision: '16' },
          type: BUY,
        }])
