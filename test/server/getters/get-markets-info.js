      ...
      assert.deepEqual(marketsInfo, [
        {
          ...
          settlementFee: new BigNumber("0.03", 10),
          ...
          outstandingShares: new BigNumber("0", 10),
      ...
      assert.deepEqual(marketsInfo, [
        {
          ...
          volume: new BigNumber("10", 10),
          outstandingShares: new BigNumber("10", 10),
          feeWindow: "0x1000000000000000000000000000000000000000",
          endDate: 1507573470,
          finalizationTime: null,
