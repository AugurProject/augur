...
describe(`modules/create-market/actions/liquidity-management.js`, () => {
  ...
  test({
    ...
    assertions: (store) => {
      ...
      assert.deepEqual(store.getActions(), [{ type: LOAD_PENDING_LIQUIDITY_ORDERS, data: {} }], `expected to dispatch LOAD_PENDING_LIQUIDITY_ORDERS`)
    },
  })
  ...
  test({
    ...
    assertions: (store) => {
      ...
      assert.deepEqual(store.getActions(), [{ type: ADD_MARKET_LIQUIDITY_ORDERS, data }], `expected to dispatch ADD_MARKET_LIQUIDITY_ORDERS`)
    },
  })
  ...
  test({
    ...
    assertions: (store) => {
      ...
      assert.deepEqual(store.getActions(), [{ type: CLEAR_ALL_MARKET_ORDERS, data }], `expected to dispatch CLEAR_ALL_MARKET_ORDERS`)
    },
  })
  ...
  test({
    ...
    assertions: (store) => {
      ...
      assert.deepEqual(store.getActions(), [{ type: UPDATE_LIQUIDITY_ORDER, data }], `expected to dispatch UPDATE_LIQUIDITY_ORDER`)
    },
  })
  ...
  test({
    ...
    assertions: (store) => {
      ...
      assert.deepEqual(store.getActions(), [{ type: REMOVE_LIQUIDITY_ORDER, data }], `expected to dispatch REMOVE_LIQUIDITY_ORDER`)
    },
  })
