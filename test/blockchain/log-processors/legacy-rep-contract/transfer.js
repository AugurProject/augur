...
const { processTransferLog, processTransferLogRemoval } = require("../../../../build/blockchain/log-processors/legacy-rep-contract/transfer");

describe("blockchain/log-processors/legacy-rep-contract/transfer", () => {
  const test = (t) => {
