    ...
    assertions: {
      ...
      onCompleted: (err, records) => {
        ...
        assert.deepEqual(records.market, {
          ...
          marketCreatorMailboxOwner: "0xbbb0000000000000000000000000000000000211",
          marketId: "0x0000000000000000000000000000000000000211",
          marketStateId: 17,
          marketType: "binary",
      ...
      onCompletedRemoved: (err, records) => {
        ...
        assert.deepEqual(records.market, {
          ...
          marketCreatorFeesClaimed: new BigNumber("0"),
          marketCreatorFeesCollected: new BigNumber("0"),
          marketCreatorMailbox: "0x0000000000000000000000000000000000000b0b",
          marketCreatorMailboxOwner: "0xbbb0000000000000000000000000000000000211",
