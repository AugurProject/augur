...
describe(`modules/markets/selectors/markets-all.js`, () => {
	...
	sinon.stub(mockMarket, 'assembleMarket', (marketID, market, priceHistory, isMarketOpen, favorite, outcomes, reports, accountTrades, tradesInProgress, endYear, endMonth, endDate, isBlockchainReportPhase, marketOrderBook, orderCancellation, dispatch) => {
		return market;
	});
