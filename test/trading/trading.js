    ...
    describe("abacus.calculateTradingCost", function () {
        var test = function (t) {
            it(JSON.stringify(t), function () {
                var tradingCost = abacus.calculateTradingCost(t.amount, t.price, t.makerFee, t.takerFee, t.range);
                console.log(JSON.stringify(tradingCost, null, 2));
                assert.strictEqual(tradingCost.fee.toFixed(), t.expected.fee);
                // assert.strictEqual(tradingCost.takerFee.toFixed(), t.expected.takerFee);
