...
describe("formatTradeType", function() {
  ...
  var test = function(t) {
    it(JSON.stringify(t), function() {
      t.assertions(augur.filters.formatTradeType(t.type));
    });
  };
  test({
    type: '0x1',
...
describe("formatCommonFields", function() {
  ...
  var test = function(t) {
    it(JSON.stringify(t), function() {
      t.assertions(augur.filters.formatCommonFields(t.msg));
    });
  };
  test({
    msg: {
...
describe("formatEventMessage", function() {
  // 21 tests total
  var test = function(t) {
    it(JSON.stringify(t), function() {
      t.assertions(augur.filters.formatEventMessage(t.label, t.msg));
    });
  };
  test({
    label: 'Approval',
...
describe("parseBlockMessage", function () {
  var test = function (msg) {
    it(JSON.stringify(msg), function (done) {
      augur.filters.parseBlockMessage(msg, function (parsed) {
...
describe("parseEventMessage", function () {
  var test = function (t) {
    it(t.label + ": " + JSON.stringify(t.msg), function (done) {
      augur.filters.parseEventMessage(t.label, t.msg, function (parsed) {
