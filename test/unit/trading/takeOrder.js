...
describe("takeOrder.placeBuy", function() {
	...
	var test = function(t) {
		it(t.description, function(done) {
			...
			augur.placeBuy(t.market, t.outcomeID, t.numShares, t.limitPrice, t.address, t.totalCost, t.tradingFees, t.getOrderBooks, t.doNotMakeOrders, t.tradeGroupID, t.tradeCommitmentCallback, t.tradeCommitLockCallback);
...
describe("takeOrder.placeSell", function() {
	...
	var test = function(t) {
		it(t.description, function(done) {
			...
			augur.placeSell(t.market, t.outcomeID, t.numShares, t.limitPrice, t.address, t.totalCost, t.tradingFees, t.getOrderBooks, t.doNotMakeOrders, t.tradeGroupID, t.tradeCommitmentCallback, t.tradeCommitLockCallback);
...
describe("takeOrder.placeShortSell", function() {
	...
	var test = function(t) {
		it(t.description, function(done) {
			...
			augur.placeShortSell(t.market, t.outcomeID, t.numShares, t.limitPrice, t.address, t.totalCost, t.tradingFees, t.getOrderBooks, t.doNotMakeOrders, t.tradeGroupID, t.tradeCommitmentCallback, t.tradeCommitLockCallback);
