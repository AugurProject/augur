        ...
        describe("createMarket", function () {
            ...
            describe("categorical", function () {
                ...
                test({
                    ...
                    tags: ["quotes", "严肃", "蝙蝠侠"],
                    extraInfo: "Why so serious? 为什么那么认真？"
                });
                test({
                    branch: augur.branches.dev,
                    description: "なぜそんなに真剣なんだ？ €☃...",
                    expDate: new Date("1-9-2017").getTime(),
                    minValue: 1,
                    maxValue: 2,
                    numOutcomes: 3,
                    ...
                    resolution: "http://www.brainyquote.com",
                    tags: ["quotes", "€", "☃"],
                    extraInfo: "Why so serious? なぜそんなに真剣なんだ？ €☃!"
                });
                test({
                    branch: augur.branches.dev,
            ...
            describe("scalar", function () {
                ...
                test({
                    ...
                    expDate: new Date("7-2-2017").getTime(),
                    minValue: 0,
                    maxValue: 120,
                    numOutcomes: 2,
                    makerFees: "0.5",
                ...
                test({
                    ...
                    expDate: new Date("1-2-2021").getTime(),
                    minValue: 1,
                    maxValue: 15000,
                    numOutcomes: 2,
                    tradingFee: "0.035",
            ...
            //             expDate: new Date("1/2/2018").getTime(),
            //             minValue: 0,
            //             maxValue: 1000000,
            //             numOutcomes: 2
            //         }, {
            ...
            //             expDate: new Date("1/1/2021").getTime(),
            //             minValue: 0,
            //             maxValue: 30,
            //             numOutcomes: 2
            //         }, {
            ...
            //             expDate: new Date("1/2/2025").getTime(),
            //             minValue: 0,
            //             maxValue: 1,
            //             numOutcomes: 6
            //         }],
