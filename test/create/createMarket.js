        ...
        describe("createMarket", function () {
            ...
            describe("categorical", function () {
                ...
                test({
                    ...
                    expDate: new Date("1-9-2017").getTime() / 1000 + 4,
                    minValue: 1,
                    maxValue: 2,
                    numOutcomes: 3,
                    takerFee: "0.02",
                ...
                test({
                    ...
                    expDate: new Date("1-2-2017").getTime() / 1000 + 4,
                    minValue: 10,
                    maxValue: 20,
                    numOutcomes: 3,
                    takerFee: "0.02",
                ...
                test({
                    ...
                    expDate: new Date("1-11-2017").getTime() / 1000 + 4,
                    minValue: 0,
                    maxValue: 1,
                    numOutcomes: 4,
                    takerFee: "0.02",
                ...
                test({
                    ...
                    expDate: new Date("1-4-2017").getTime() / 1000 + 4,
                    minValue: 10,
                    maxValue: 20,
                    numOutcomes: 4,
                    takerFee: "0.02",
                ...
                test({
                    ...
                    expDate: new Date("10-2-2016").getTime() / 1000 + 4,
                    minValue: 0,
                    maxValue: 1,
                    numOutcomes: 8,
                    takerFee: "0.03",
            ...
            describe("scalar", function () {
                ...
                test({
                    ...
                    expDate: new Date("7-3-2017").getTime() / 1000 + 4,
                    minValue: 0,
                    maxValue: 120,
                    numOutcomes: 2,
                    takerFee: "0.02",
                ...
                test({
                    ...
                    expDate: new Date("1-2-2021").getTime() / 1000 + 4,
                    minValue: 1,
                    maxValue: 15000,
                    numOutcomes: 2,
                    takerFee: "0.02",
            ...
            describe("binary", function () {
                var events = [[
                    ...
                    new Date("1-1-2018").getTime() / 1000 + 4,
                    "NASA",
                    {
                    ...
                    new Date("1-1-2019").getTime() / 1000 + 4,
                    "generic",
                    {
