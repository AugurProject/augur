...
Among others, [`isContract`](#Address.isContract(address)) will return false for the following
types of addresses:
...
Same as {xref-Address-functionCall-address-bytes-}[[`functionCall`](#Address.functionCall(address,bytes))], but with
...
Same as {xref-Address-functionCall-address-bytes-}[[`functionCall`](#Address.functionCall(address,bytes))],
...
Same as {xref-Address-functionCallWithValue-address-bytes-uint256-}[[`functionCallWithValue`](#Address.functionCallWithValue(address,bytes,uint256))], but
...
Same as {xref-Address-functionCall-address-bytes-string-}[[`functionCall`](#Address.functionCall(address,bytes))],
but performing a static call.
