...
<h4><a class="anchor" aria-hidden="true" id="AMMExchange.removeLiquidity(uint256)"></a><code class="function-signature">removeLiquidity(uint256 _poolTokensToSell) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMExchange.rateRemoveLiquidity(uint256)"></a><code class="function-signature">rateRemoveLiquidity(uint256 _poolTokensToSell) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMExchange.swap(uint256,bool,uint256)"></a><code class="function-signature">swap(uint256 _inputShares, bool _outputLong, uint256 _minOutputShares) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMExchange.rateSwap(uint256,bool)"></a><code class="function-signature">rateSwap(uint256 _inputShares, bool _outputLong) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMExchange.shortLongShareBalances(address)"></a><code class="function-signature">shortLongShareBalances(address _owner) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">internal</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMExchange.shareTransfer(address,address,uint256,uint256,uint256)"></a><code class="function-signature">shareTransfer(address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code><span class="function-visibility">internal</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMExchange.calculateReverseSwap(uint256,uint256,uint256)"></a><code class="function-signature">calculateReverseSwap(uint256 _reserveA, uint256 _reserveB, uint256 _deltaB) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">internal</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMExchange.symbol()"></a><code class="function-signature">symbol() <span class="return-arrow">→</span> <span class="return-type">string</span></code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMExchange.SwapPosition(address,uint256,uint256,bool)"></a><code class="function-signature">SwapPosition(address sender, uint256 inputShares, uint256 outputShares, bool outputLong)</code><span class="function-visibility"></span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMExchange.RemoveLiquidity(address,uint256,uint256,uint256)"></a><code class="function-signature">RemoveLiquidity(address sender, uint256 shortShares, uint256 longShares, uint256 lpTokensBurnt)</code><span class="function-visibility"></span></h4>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li class="inherited"><a href="para#BBronze.getColor()"><code class="function-signature">getColor()</code></a></li></ul></div>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#BTokenBase._mint(uint256)"><code class="function-signature">_mint(uint256 amt)</code></a></li><li><a href="#BTokenBase._burn(uint256)"><code class="function-signature">_burn(uint256 amt)</code></a></li><li><a href="#BTokenBase._move(address,address,uint256)"><code class="function-signature">_move(address src, address dst, uint256 amt)</code></a></li><li><a href="#BTokenBase._push(address,uint256)"><code class="function-signature">_push(address to, uint256 amt)</code></a></li><li><a href="#BTokenBase._pull(address,uint256)"><code class="function-signature">_pull(address from, uint256 amt)</code></a></li><li class="inherited"><a href="para#BNum.btoi(uint256)"><code class="function-signature">btoi(uint256 a)</code></a></li><li class="inherited"><a href="para#BNum.bfloor(uint256)"><code class="function-signature">bfloor(uint256 a)</code></a></li><li class="inherited"><a href="para#BNum.badd(uint256,uint256)"><code class="function-signature">badd(uint256 a, uint256 b)</code></a></li><li class="inherited"><a href="para#BNum.bsub(uint256,uint256)"><code class="function-signature">bsub(uint256 a, uint256 b)</code></a></li><li class="inherited"><a href="para#BNum.bsubSign(uint256,uint256)"><code class="function-signature">bsubSign(uint256 a, uint256 b)</code></a></li><li class="inherited"><a href="para#BNum.bmul(uint256,uint256)"><code class="function-signature">bmul(uint256 a, uint256 b)</code></a></li><li class="inherited"><a href="para#BNum.bdiv(uint256,uint256)"><code class="function-signature">bdiv(uint256 a, uint256 b)</code></a></li><li class="inherited"><a href="para#BNum.bpowi(uint256,uint256)"><code class="function-signature">bpowi(uint256 a, uint256 n)</code></a></li><li class="inherited"><a href="para#BNum.bpow(uint256,uint256)"><code class="function-signature">bpow(uint256 base, uint256 exp)</code></a></li><li class="inherited"><a href="para#BNum.bpowApprox(uint256,uint256,uint256)"><code class="function-signature">bpowApprox(uint256 base, uint256 exp, uint256 precision)</code></a></li><li class="inherited"><a href="para#BBronze.getColor()"><code class="function-signature">getColor()</code></a></li></ul><span class="contract-index-title">Events</span><ul><li><a href="#BTokenBase.Approval(address,address,uint256)"><code class="function-signature">Approval(address src, address dst, uint256 amt)</code></a></li><li><a href="#BTokenBase.Transfer(address,address,uint256)"><code class="function-signature">Transfer(address src, address dst, uint256 amt)</code></a></li></ul></div>
...
<h4><a class="anchor" aria-hidden="true" id="IAMMExchange.removeLiquidity(uint256)"></a><code class="function-signature">removeLiquidity(uint256 _poolTokensToSell) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IAMMExchange.rateRemoveLiquidity(uint256)"></a><code class="function-signature">rateRemoveLiquidity(uint256 _poolTokensToSell) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">public</span></h4>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#IAMMFactory.addAMMWithLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,uint256,bool,address,string[])"><code class="function-signature">addAMMWithLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, uint256 _ratioFactor, bool _keepYes, address _recipient, string[] _symbols)</code></a></li><li><a href="#IAMMFactory.addLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,address,uint256,string[])"><code class="function-signature">addLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, address _recipient, uint256 _cashToInvalidPool, string[] _symbols)</code></a></li><li><a href="#IAMMFactory.getBPool(contract IMarket,contract IParaShareToken,uint256)"><code class="function-signature">getBPool(contract IMarket _market, contract IParaShareToken _para, uint256 _fee)</code></a></li><li><a href="#IAMMFactory.removeLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,string[])"><code class="function-signature">removeLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _poolTokensToSell, string[] _symbols)</code></a></li><li><a href="#IAMMFactory.balanceOf(contract IMarket,contract IParaShareToken,uint256,address)"><code class="function-signature">balanceOf(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _account)</code></a></li><li><a href="#IAMMFactory.salt(contract IMarket,contract IParaShareToken,uint256)"><code class="function-signature">salt(contract IMarket _market, contract IParaShareToken _para, uint256 _fee)</code></a></li><li><a href="#IAMMFactory.transferCash(contract IMarket,contract IParaShareToken,uint256,address,address,uint256)"><code class="function-signature">transferCash(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address sender, address recipient, uint256 quantity)</code></a></li><li><a href="#IAMMFactory.shareTransfer(contract IMarket,contract IParaShareToken,uint256,address,address,uint256,uint256,uint256)"><code class="function-signature">shareTransfer(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code></a></li></ul></div>



<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.addAMMWithLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,uint256,bool,address,string[])"></a><code class="function-signature">addAMMWithLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, uint256 _ratioFactor, bool _keepYes, address _recipient, string[] _symbols) <span class="return-arrow">→</span> <span class="return-type">address,uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.addLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,address,uint256,string[])"></a><code class="function-signature">addLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, address _recipient, uint256 _cashToInvalidPool, string[] _symbols) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.getBPool(contract IMarket,contract IParaShareToken,uint256)"></a><code class="function-signature">getBPool(contract IMarket _market, contract IParaShareToken _para, uint256 _fee) <span class="return-arrow">→</span> <span class="return-type">address</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.removeLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,string[])"></a><code class="function-signature">removeLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _poolTokensToSell, string[] _symbols) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.balanceOf(contract IMarket,contract IParaShareToken,uint256,address)"></a><code class="function-signature">balanceOf(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _account) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.salt(contract IMarket,contract IParaShareToken,uint256)"></a><code class="function-signature">salt(contract IMarket _market, contract IParaShareToken _para, uint256 _fee) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.transferCash(contract IMarket,contract IParaShareToken,uint256,address,address,uint256)"></a><code class="function-signature">transferCash(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address sender, address recipient, uint256 quantity)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.shareTransfer(contract IMarket,contract IParaShareToken,uint256,address,address,uint256,uint256,uint256)"></a><code class="function-signature">shareTransfer(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code><span class="function-visibility">public</span></h4>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#ICash.faucet(uint256)"><code class="function-signature">faucet(uint256 _amount)</code></a></li><li class="inherited"><a href="para#IERC20.totalSupply()"><code class="function-signature">totalSupply()</code></a></li><li class="inherited"><a href="para#IERC20.balanceOf(address)"><code class="function-signature">balanceOf(address owner)</code></a></li><li class="inherited"><a href="para#IERC20.transfer(address,uint256)"><code class="function-signature">transfer(address to, uint256 amount)</code></a></li><li class="inherited"><a href="para#IERC20.transferFrom(address,address,uint256)"><code class="function-signature">transferFrom(address from, address to, uint256 amount)</code></a></li><li class="inherited"><a href="para#IERC20.approve(address,uint256)"><code class="function-signature">approve(address spender, uint256 amount)</code></a></li><li class="inherited"><a href="para#IERC20.allowance(address,address)"><code class="function-signature">allowance(address owner, address spender)</code></a></li></ul><span class="contract-index-title">Events</span><ul><li class="inherited"><a href="para#IERC20.Transfer(address,address,uint256)"><code class="function-signature">Transfer(address from, address to, uint256 value)</code></a></li><li class="inherited"><a href="para#IERC20.Approval(address,address,uint256)"><code class="function-signature">Approval(address owner, address spender, uint256 value)</code></a></li></ul></div>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#IERC20Proxy1155.initialize(contract IERC20Proxy1155Nexus,uint256)"><code class="function-signature">initialize(contract IERC20Proxy1155Nexus _nexus, uint256 _tokenId)</code></a></li><li><a href="#IERC20Proxy1155.logApproval(address,address,uint256)"><code class="function-signature">logApproval(address _owner, address _spender, uint256 _amount)</code></a></li><li><a href="#IERC20Proxy1155.logTransfer(address,address,uint256)"><code class="function-signature">logTransfer(address _sender, address _recipient, uint256 _amount)</code></a></li><li class="inherited"><a href="para#IERC20.totalSupply()"><code class="function-signature">totalSupply()</code></a></li><li class="inherited"><a href="para#IERC20.balanceOf(address)"><code class="function-signature">balanceOf(address owner)</code></a></li><li class="inherited"><a href="para#IERC20.transfer(address,uint256)"><code class="function-signature">transfer(address to, uint256 amount)</code></a></li><li class="inherited"><a href="para#IERC20.transferFrom(address,address,uint256)"><code class="function-signature">transferFrom(address from, address to, uint256 amount)</code></a></li><li class="inherited"><a href="para#IERC20.approve(address,uint256)"><code class="function-signature">approve(address spender, uint256 amount)</code></a></li><li class="inherited"><a href="para#IERC20.allowance(address,address)"><code class="function-signature">allowance(address owner, address spender)</code></a></li></ul><span class="contract-index-title">Events</span><ul><li class="inherited"><a href="para#IERC20.Transfer(address,address,uint256)"><code class="function-signature">Transfer(address from, address to, uint256 value)</code></a></li><li class="inherited"><a href="para#IERC20.Approval(address,address,uint256)"><code class="function-signature">Approval(address owner, address spender, uint256 value)</code></a></li></ul></div>



<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155.initialize(contract IERC20Proxy1155Nexus,uint256)"></a><code class="function-signature">initialize(contract IERC20Proxy1155Nexus _nexus, uint256 _tokenId)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155.logApproval(address,address,uint256)"></a><code class="function-signature">logApproval(address _owner, address _spender, uint256 _amount)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155.logTransfer(address,address,uint256)"></a><code class="function-signature">logTransfer(address _sender, address _recipient, uint256 _amount)</code><span class="function-visibility">public</span></h4>
...
### `IERC20Proxy1155Nexus`



<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#IERC20Proxy1155Nexus.calculateERC20(uint256)"><code class="function-signature">calculateERC20(uint256 _tokenId)</code></a></li><li><a href="#IERC20Proxy1155Nexus.newERC20(uint256)"><code class="function-signature">newERC20(uint256 _tokenId)</code></a></li><li><a href="#IERC20Proxy1155Nexus.newERC20s(uint256[])"><code class="function-signature">newERC20s(uint256[] _tokenIds)</code></a></li><li><a href="#IERC20Proxy1155Nexus.transfer(contract IERC20Proxy1155,address,address,uint256)"><code class="function-signature">transfer(contract IERC20Proxy1155 _proxy, address _caller, address _to, uint256 _amount)</code></a></li><li><a href="#IERC20Proxy1155Nexus.transferFrom(contract IERC20Proxy1155,address,address,address,uint256)"><code class="function-signature">transferFrom(contract IERC20Proxy1155 _proxy, address _caller, address _from, address _to, uint256 _amount)</code></a></li><li><a href="#IERC20Proxy1155Nexus.approve(contract IERC20Proxy1155,address,address,uint256)"><code class="function-signature">approve(contract IERC20Proxy1155 _proxy, address _caller, address _spender, uint256 _amount)</code></a></li><li><a href="#IERC20Proxy1155Nexus.allowance(contract IERC20Proxy1155,address,address)"><code class="function-signature">allowance(contract IERC20Proxy1155 _proxy, address _owner, address _spender)</code></a></li></ul></div>



<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155Nexus.calculateERC20(uint256)"></a><code class="function-signature">calculateERC20(uint256 _tokenId) <span class="return-arrow">→</span> <span class="return-type">address</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155Nexus.newERC20(uint256)"></a><code class="function-signature">newERC20(uint256 _tokenId) <span class="return-arrow">→</span> <span class="return-type">contract IERC20Proxy1155</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155Nexus.newERC20s(uint256[])"></a><code class="function-signature">newERC20s(uint256[] _tokenIds) <span class="return-arrow">→</span> <span class="return-type">contract IERC20Proxy1155[]</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155Nexus.transfer(contract IERC20Proxy1155,address,address,uint256)"></a><code class="function-signature">transfer(contract IERC20Proxy1155 _proxy, address _caller, address _to, uint256 _amount) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155Nexus.transferFrom(contract IERC20Proxy1155,address,address,address,uint256)"></a><code class="function-signature">transferFrom(contract IERC20Proxy1155 _proxy, address _caller, address _from, address _to, uint256 _amount) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155Nexus.approve(contract IERC20Proxy1155,address,address,uint256)"></a><code class="function-signature">approve(contract IERC20Proxy1155 _proxy, address _caller, address _spender, uint256 _amount) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="IERC20Proxy1155Nexus.allowance(contract IERC20Proxy1155,address,address)"></a><code class="function-signature">allowance(contract IERC20Proxy1155 _proxy, address _owner, address _spender) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#AMMFactory.constructor(address,contract BFactory,contract WrappedShareTokenFactory)"><code class="function-signature">constructor(address _proxyToClone, contract BFactory _bFactory, contract WrappedShareTokenFactory _wrappedShareTokenFactory)</code></a></li><li><a href="#AMMFactory.addLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,address,uint256,string[])"><code class="function-signature">addLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, address _recipient, uint256 _cashToInvalidPool, string[] _symbols)</code></a></li><li><a href="#AMMFactory.addInitialLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,uint256,bool,address)"><code class="function-signature">addInitialLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, uint256 _ratioFactor, bool _keepLong, address _recipient)</code></a></li><li><a href="#AMMFactory.removeLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,string[])"><code class="function-signature">removeLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _poolTokensToSell, string[] _symbols)</code></a></li><li><a href="#AMMFactory.exitBPool(contract IMarket,contract IParaShareToken,contract WrappedShareTokenFactory,address,string)"><code class="function-signature">exitBPool(contract IMarket _market, contract IParaShareToken _para, contract WrappedShareTokenFactory wrappedShareTokenFactory, address _ammAddress, string _symbol)</code></a></li><li><a href="#AMMFactory.sendAllShares(contract IMarket,contract IParaShareToken,uint256,address)"><code class="function-signature">sendAllShares(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _target)</code></a></li><li><a href="#AMMFactory.getAMM(contract IMarket,contract IParaShareToken,uint256)"><code class="function-signature">getAMM(contract IMarket _market, contract IParaShareToken _para, uint256 _fee)</code></a></li><li><a href="#AMMFactory.getBPool(contract IMarket,contract IParaShareToken,uint256)"><code class="function-signature">getBPool(contract IMarket _market, contract IParaShareToken _para, uint256 _fee)</code></a></li><li><a href="#AMMFactory.balanceOf(contract IMarket,contract IParaShareToken,uint256,address)"><code class="function-signature">balanceOf(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _account)</code></a></li><li><a href="#AMMFactory.addAMMWithLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,uint256,bool,address,string[])"><code class="function-signature">addAMMWithLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, uint256 _ratioFactor, bool _keepLong, address _recipient, string[] _symbols)</code></a></li><li><a href="#AMMFactory.addLiquidityToBPool(contract IMarket,contract IParaShareToken,contract BPool,uint256,address,string[])"><code class="function-signature">addLiquidityToBPool(contract IMarket _market, contract IParaShareToken _para, contract BPool _bPool, uint256 _cashToInvalidPool, address _recipient, string[] _symbols)</code></a></li><li><a href="#AMMFactory.transferCash(contract IMarket,contract IParaShareToken,uint256,address,address,uint256)"><code class="function-signature">transferCash(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _sender, address _recipient, uint256 _quantity)</code></a></li><li><a href="#AMMFactory.shareTransfer(contract IMarket,contract IParaShareToken,uint256,address,address,uint256,uint256,uint256)"><code class="function-signature">shareTransfer(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code></a></li><li><a href="#AMMFactory.shareTransferInternal(contract IMarket,contract IParaShareToken,uint256,address,address,uint256,uint256,uint256)"><code class="function-signature">shareTransferInternal(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code></a></li><li><a href="#AMMFactory.claimMarketsProceeds(contract IMarket[],contract IParaShareToken[],address payable,bytes32)"><code class="function-signature">claimMarketsProceeds(contract IMarket[] _markets, contract IParaShareToken[] _shareTokens, address payable _shareHolder, bytes32 _fingerprint)</code></a></li><li><a href="#AMMFactory.calculateAMMAddress(contract IMarket,contract IParaShareToken,uint256)"><code class="function-signature">calculateAMMAddress(contract IMarket _market, contract IParaShareToken _para, uint256 _fee)</code></a></li><li><a href="#AMMFactory.salt(contract IMarket,contract IParaShareToken,uint256)"><code class="function-signature">salt(contract IMarket _market, contract IParaShareToken _para, uint256 _fee)</code></a></li><li class="inherited"><a href="para#CloneFactory2.createClone2(address,uint256)"><code class="function-signature">createClone2(address target, uint256 salt)</code></a></li><li class="inherited"><a href="para#CloneFactory2.clone2Address(address,uint256,address)"><code class="function-signature">clone2Address(address target, uint256 salt, address creator)</code></a></li></ul><span class="contract-index-title">Events</span><ul><li><a href="#AMMFactory.AMMCreated(contract IAMMExchange,contract IMarket,contract IParaShareToken,uint256,contract BPool,string[])"><code class="function-signature">AMMCreated(contract IAMMExchange amm, contract IMarket market, contract IParaShareToken shareToken, uint256 fee, contract BPool bPool, string[] _symbols)</code></a></li></ul></div>



<h4><a class="anchor" aria-hidden="true" id="AMMFactory.constructor(address,contract BFactory,contract WrappedShareTokenFactory)"></a><code class="function-signature">constructor(address _proxyToClone, contract BFactory _bFactory, contract WrappedShareTokenFactory _wrappedShareTokenFactory)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.addLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,address,uint256,string[])"></a><code class="function-signature">addLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, address _recipient, uint256 _cashToInvalidPool, string[] _symbols) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.addInitialLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,uint256,bool,address)"></a><code class="function-signature">addInitialLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, uint256 _ratioFactor, bool _keepLong, address _recipient) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.removeLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,string[])"></a><code class="function-signature">removeLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _poolTokensToSell, string[] _symbols) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.exitBPool(contract IMarket,contract IParaShareToken,contract WrappedShareTokenFactory,address,string)"></a><code class="function-signature">exitBPool(contract IMarket _market, contract IParaShareToken _para, contract WrappedShareTokenFactory wrappedShareTokenFactory, address _ammAddress, string _symbol)</code><span class="function-visibility">internal</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.sendAllShares(contract IMarket,contract IParaShareToken,uint256,address)"></a><code class="function-signature">sendAllShares(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _target) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">internal</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.getAMM(contract IMarket,contract IParaShareToken,uint256)"></a><code class="function-signature">getAMM(contract IMarket _market, contract IParaShareToken _para, uint256 _fee) <span class="return-arrow">→</span> <span class="return-type">address</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.getBPool(contract IMarket,contract IParaShareToken,uint256)"></a><code class="function-signature">getBPool(contract IMarket _market, contract IParaShareToken _para, uint256 _fee) <span class="return-arrow">→</span> <span class="return-type">address</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.balanceOf(contract IMarket,contract IParaShareToken,uint256,address)"></a><code class="function-signature">balanceOf(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _account) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.addAMMWithLiquidity(contract IMarket,contract IParaShareToken,uint256,uint256,uint256,bool,address,string[])"></a><code class="function-signature">addAMMWithLiquidity(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, uint256 _cash, uint256 _ratioFactor, bool _keepLong, address _recipient, string[] _symbols) <span class="return-arrow">→</span> <span class="return-type">address,uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.addLiquidityToBPool(contract IMarket,contract IParaShareToken,contract BPool,uint256,address,string[])"></a><code class="function-signature">addLiquidityToBPool(contract IMarket _market, contract IParaShareToken _para, contract BPool _bPool, uint256 _cashToInvalidPool, address _recipient, string[] _symbols)</code><span class="function-visibility">internal</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.transferCash(contract IMarket,contract IParaShareToken,uint256,address,address,uint256)"></a><code class="function-signature">transferCash(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _sender, address _recipient, uint256 _quantity)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.shareTransfer(contract IMarket,contract IParaShareToken,uint256,address,address,uint256,uint256,uint256)"></a><code class="function-signature">shareTransfer(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.shareTransferInternal(contract IMarket,contract IParaShareToken,uint256,address,address,uint256,uint256,uint256)"></a><code class="function-signature">shareTransferInternal(contract IMarket _market, contract IParaShareToken _para, uint256 _fee, address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code><span class="function-visibility">internal</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.claimMarketsProceeds(contract IMarket[],contract IParaShareToken[],address payable,bytes32)"></a><code class="function-signature">claimMarketsProceeds(contract IMarket[] _markets, contract IParaShareToken[] _shareTokens, address payable _shareHolder, bytes32 _fingerprint) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.calculateAMMAddress(contract IMarket,contract IParaShareToken,uint256)"></a><code class="function-signature">calculateAMMAddress(contract IMarket _market, contract IParaShareToken _para, uint256 _fee) <span class="return-arrow">→</span> <span class="return-type">address</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.salt(contract IMarket,contract IParaShareToken,uint256)"></a><code class="function-signature">salt(contract IMarket _market, contract IParaShareToken _para, uint256 _fee) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMFactory.AMMCreated(contract IAMMExchange,contract IMarket,contract IParaShareToken,uint256,contract BPool,string[])"></a><code class="function-signature">AMMCreated(contract IAMMExchange amm, contract IMarket market, contract IParaShareToken shareToken, uint256 fee, contract BPool bPool, string[] _symbols)</code><span class="function-visibility"></span></h4>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#ERC1155Receiver.constructor()"><code class="function-signature">constructor()</code></a></li><li class="inherited"><a href="#IERC1155Receiver.onERC1155Received(address,address,uint256,uint256,bytes)"><code class="function-signature">onERC1155Received(address operator, address from, uint256 id, uint256 value, bytes data)</code></a></li><li class="inherited"><a href="#IERC1155Receiver.onERC1155BatchReceived(address,address,uint256[],uint256[],bytes)"><code class="function-signature">onERC1155BatchReceived(address operator, address from, uint256[] ids, uint256[] values, bytes data)</code></a></li><li class="inherited"><a href="#ERC165.supportsInterface(bytes4)"><code class="function-signature">supportsInterface(bytes4 interfaceId)</code></a></li><li class="inherited"><a href="#ERC165._registerInterface(bytes4)"><code class="function-signature">_registerInterface(bytes4 interfaceId)</code></a></li></ul></div>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#WrappedShareToken.initialize(contract IParaShareToken,uint256,string)"><code class="function-signature">initialize(contract IParaShareToken _shareToken, uint256 _tokenId, string _symbol)</code></a></li><li><a href="#WrappedShareToken.wrapShares(address,uint256)"><code class="function-signature">wrapShares(address _recipient, uint256 _amountIn)</code></a></li><li><a href="#WrappedShareToken.trustedWrapShares(address,uint256)"><code class="function-signature">trustedWrapShares(address _recipient, uint256 _amountIn)</code></a></li><li><a href="#WrappedShareToken.unwrapShares(address,address,uint256)"><code class="function-signature">unwrapShares(address _holder, address _recipient, uint256 _amountIn)</code></a></li><li><a href="#WrappedShareToken.claimTradingProceeds(address)"><code class="function-signature">claimTradingProceeds(address _shareHolder)</code></a></li><li><a href="#WrappedShareToken.onERC1155Received(address,address,uint256,uint256,bytes)"><code class="function-signature">onERC1155Received(address operator, address from, uint256 id, uint256 value, bytes data)</code></a></li><li><a href="#WrappedShareToken.onERC1155BatchReceived(address,address,uint256[],uint256[],bytes)"><code class="function-signature">onERC1155BatchReceived(address operator, address from, uint256[] ids, uint256[] values, bytes data)</code></a></li><li><a href="#WrappedShareToken.onTokenTransfer(address,address,uint256)"><code class="function-signature">onTokenTransfer(address _from, address _to, uint256 _value)</code></a></li><li><a href="#WrappedShareToken.onTransferOwnership(address,address)"><code class="function-signature">onTransferOwnership(address, address)</code></a></li><li><a href="#WrappedShareToken.getMarket()"><code class="function-signature">getMarket()</code></a></li><li><a href="#WrappedShareToken.getOutcome()"><code class="function-signature">getOutcome()</code></a></li><li class="inherited"><a href="para#ERC1155Receiver.constructor()"><code class="function-signature">constructor()</code></a></li><li class="inherited"><a href="#ERC165.supportsInterface(bytes4)"><code class="function-signature">supportsInterface(bytes4 interfaceId)</code></a></li><li class="inherited"><a href="#ERC165._registerInterface(bytes4)"><code class="function-signature">_registerInterface(bytes4 interfaceId)</code></a></li><li class="inherited"><a href="#Ownable.getOwner()"><code class="function-signature">getOwner()</code></a></li><li class="inherited"><a href="#Ownable.transferOwnership(address)"><code class="function-signature">transferOwnership(address _newOwner)</code></a></li><li class="inherited"><a href="#Initializable.endInitialization()"><code class="function-signature">endInitialization()</code></a></li><li class="inherited"><a href="#Initializable.getInitialized()"><code class="function-signature">getInitialized()</code></a></li><li class="inherited"><a href="#ERC20.balanceOf(address)"><code class="function-signature">balanceOf(address _account)</code></a></li><li class="inherited"><a href="#ERC20.transfer(address,uint256)"><code class="function-signature">transfer(address _recipient, uint256 _amount)</code></a></li><li class="inherited"><a href="#ERC20.allowance(address,address)"><code class="function-signature">allowance(address _owner, address _spender)</code></a></li><li class="inherited"><a href="#ERC20.approve(address,uint256)"><code class="function-signature">approve(address _spender, uint256 _amount)</code></a></li><li class="inherited"><a href="#ERC20.transferFrom(address,address,uint256)"><code class="function-signature">transferFrom(address _sender, address _recipient, uint256 _amount)</code></a></li><li class="inherited"><a href="#ERC20.increaseAllowance(address,uint256)"><code class="function-signature">increaseAllowance(address _spender, uint256 _addedValue)</code></a></li><li class="inherited"><a href="#ERC20.decreaseAllowance(address,uint256)"><code class="function-signature">decreaseAllowance(address _spender, uint256 _subtractedValue)</code></a></li><li class="inherited"><a href="#ERC20._transfer(address,address,uint256)"><code class="function-signature">_transfer(address _sender, address _recipient, uint256 _amount)</code></a></li><li class="inherited"><a href="#ERC20._mint(address,uint256)"><code class="function-signature">_mint(address _account, uint256 _amount)</code></a></li><li class="inherited"><a href="#ERC20._burn(address,uint256)"><code class="function-signature">_burn(address _account, uint256 _amount)</code></a></li><li class="inherited"><a href="#ERC20._approve(address,address,uint256)"><code class="function-signature">_approve(address _owner, address _spender, uint256 _amount)</code></a></li><li class="inherited"><a href="#ERC20._burnFrom(address,uint256)"><code class="function-signature">_burnFrom(address _account, uint256 _amount)</code></a></li><li class="inherited"><a href="#IERC20.totalSupply()"><code class="function-signature">totalSupply()</code></a></li></ul><span class="contract-index-title">Events</span><ul><li class="inherited"><a href="#IERC20.Transfer(address,address,uint256)"><code class="function-signature">Transfer(address from, address to, uint256 value)</code></a></li><li class="inherited"><a href="#IERC20.Approval(address,address,uint256)"><code class="function-signature">Approval(address owner, address spender, uint256 value)</code></a></li></ul></div>
...
<h4><a class="anchor" aria-hidden="true" id="WrappedShareToken.unwrapShares(address,address,uint256)"></a><code class="function-signature">unwrapShares(address _holder, address _recipient, uint256 _amountIn)</code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.getOrCreateWrappedShareTokens(contract IParaShareToken,uint256[],string[])"></a><code class="function-signature">getOrCreateWrappedShareTokens(contract IParaShareToken _shareToken, uint256[] _tokenIds, string[] _symbols) <span class="return-arrow">→</span> <span class="return-type">contract WrappedShareToken[]</span></code><span class="function-visibility">public</span></h4>

creates new ERC20 wrappers for multiple tokenIds



<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.wrapShares(contract IParaShareToken,uint256,string,address,uint256)"></a><code class="function-signature">wrapShares(contract IParaShareToken _shareToken, uint256 _tokenId, string _symbol, address _account, uint256 _amount)</code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.unwrapShares(contract IParaShareToken,uint256,string,uint256)"></a><code class="function-signature">unwrapShares(contract IParaShareToken _shareToken, uint256 _tokenId, string _symbol, uint256 _amount)</code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.unwrapAllShares(contract IParaShareToken,uint256,string)"></a><code class="function-signature">unwrapAllShares(contract IParaShareToken _shareToken, uint256 _tokenId, string _symbol)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.wrapMultipleShares(contract IParaShareToken,uint256[],string[],address,uint256[])"></a><code class="function-signature">wrapMultipleShares(contract IParaShareToken _shareToken, uint256[] _tokenIds, string[] _symbols, address _account, uint256[] _amounts)</code><span class="function-visibility">public</span></h4>

wraps multiple tokens 



<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.unwrapMultipleShares(contract IParaShareToken,uint256[],string[],uint256[])"></a><code class="function-signature">unwrapMultipleShares(contract IParaShareToken _shareToken, uint256[] _tokenIds, string[] _symbols, uint256[] _amounts)</code><span class="function-visibility">public</span></h4>

unwraps multiple tokens 



<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.publicBuyCompleteSets(contract IMarket,contract IParaShareToken,string[],uint256)"></a><code class="function-signature">publicBuyCompleteSets(contract IMarket _market, contract IParaShareToken _shareToken, string[] _symbols, uint256 _amount) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.publicSellCompleteSets(contract IParaShareToken,contract IMarket,string[],uint256)"></a><code class="function-signature">publicSellCompleteSets(contract IParaShareToken _shareToken, contract IMarket _market, string[] _symbols, uint256 _amount) <span class="return-arrow">→</span> <span class="return-type">uint256,uint256</span></code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="WrappedShareTokenFactory.calculateShareTokenAddress(contract IParaShareToken,uint256,string)"></a><code class="function-signature">calculateShareTokenAddress(contract IParaShareToken _shareToken, uint256 _tokenId, string _symbol) <span class="return-arrow">→</span> <span class="return-type">address</span></code><span class="function-visibility">public</span></h4>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#WethWrapperForAMMExchange.fallback()"><code class="function-signature">fallback()</code></a></li><li><a href="#WethWrapperForAMMExchange.constructor(contract IAMMFactory,contract IParaShareToken)"><code class="function-signature">constructor(contract IAMMFactory _factory, contract IParaShareToken _shareToken)</code></a></li><li><a href="#WethWrapperForAMMExchange.addAMMWithLiquidity(contract IMarket,uint256,uint256,bool,address,string[])"><code class="function-signature">addAMMWithLiquidity(contract IMarket _market, uint256 _fee, uint256 _ratioFactor, bool _keepLong, address _recipient, string[] _symbols)</code></a></li><li><a href="#WethWrapperForAMMExchange.getAMM(contract IMarket,uint256)"><code class="function-signature">getAMM(contract IMarket _market, uint256 _fee)</code></a></li><li><a href="#WethWrapperForAMMExchange.getBPool(contract IMarket,contract IParaShareToken,uint256)"><code class="function-signature">getBPool(contract IMarket _market, contract IParaShareToken _para, uint256 _fee)</code></a></li><li><a href="#WethWrapperForAMMExchange.addInitialLiquidity(contract IMarket,uint256,uint256,bool,address)"><code class="function-signature">addInitialLiquidity(contract IMarket _market, uint256 _fee, uint256 _ratioFactor, bool _keepLong, address _recipient)</code></a></li><li><a href="#WethWrapperForAMMExchange.addLiquidity(contract IMarket,uint256,address)"><code class="function-signature">addLiquidity(contract IMarket _market, uint256 _fee, address _recipient)</code></a></li><li><a href="#WethWrapperForAMMExchange.enterPosition(contract IMarket,uint256,bool,uint256)"><code class="function-signature">enterPosition(contract IMarket _market, uint256 _fee, bool _buyLong, uint256 _minShares)</code></a></li><li><a href="#WethWrapperForAMMExchange.exitPosition(contract IMarket,uint256,uint256,uint256,uint256)"><code class="function-signature">exitPosition(contract IMarket _market, uint256 _fee, uint256 _shortShares, uint256 _longShares, uint256 _minCashPayout)</code></a></li><li><a href="#WethWrapperForAMMExchange.exitAll(contract IMarket,uint256,uint256)"><code class="function-signature">exitAll(contract IMarket _market, uint256 _fee, uint256 _minCashPayout)</code></a></li><li><a href="#WethWrapperForAMMExchange.claimTradingProceeds(contract IMarket,address payable,bytes32)"><code class="function-signature">claimTradingProceeds(contract IMarket _market, address payable _shareHolder, bytes32 _fingerprint)</code></a></li><li><a href="#WethWrapperForAMMExchange.claimMarketsProceeds(contract IMarket[],contract IParaShareToken[],address payable,bytes32)"><code class="function-signature">claimMarketsProceeds(contract IMarket[] _markets, contract IParaShareToken[] _shareTokens, address payable _shareHolder, bytes32 _fingerprint)</code></a></li></ul><span class="contract-index-title">Events</span><ul><li><a href="#WethWrapperForAMMExchange.AddLiquidity(address,address)"><code class="function-signature">AddLiquidity(address amm, address sender)</code></a></li><li><a href="#WethWrapperForAMMExchange.EnterPosition(address,address)"><code class="function-signature">EnterPosition(address amm, address sender)</code></a></li><li><a href="#WethWrapperForAMMExchange.ExitPosition(address,address)"><code class="function-signature">ExitPosition(address amm, address sender)</code></a></li><li><a href="#WethWrapperForAMMExchange.RemoveLiquidity(address,address)"><code class="function-signature">RemoveLiquidity(address amm, address sender)</code></a></li><li><a href="#WethWrapperForAMMExchange.TradingProceedsClaimed(address)"><code class="function-signature">TradingProceedsClaimed(address sender)</code></a></li></ul></div>



<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.fallback()"></a><code class="function-signature">fallback()</code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.constructor(contract IAMMFactory,contract IParaShareToken)"></a><code class="function-signature">constructor(contract IAMMFactory _factory, contract IParaShareToken _shareToken)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.addAMMWithLiquidity(contract IMarket,uint256,uint256,bool,address,string[])"></a><code class="function-signature">addAMMWithLiquidity(contract IMarket _market, uint256 _fee, uint256 _ratioFactor, bool _keepLong, address _recipient, string[] _symbols) <span class="return-arrow">→</span> <span class="return-type">address,uint256</span></code><span class="function-visibility">external</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.getBPool(contract IMarket,contract IParaShareToken,uint256)"></a><code class="function-signature">getBPool(contract IMarket _market, contract IParaShareToken _para, uint256 _fee) <span class="return-arrow">→</span> <span class="return-type">address</span></code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.claimMarketsProceeds(contract IMarket[],contract IParaShareToken[],address payable,bytes32)"></a><code class="function-signature">claimMarketsProceeds(contract IMarket[] _markets, contract IParaShareToken[] _shareTokens, address payable _shareHolder, bytes32 _fingerprint) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">external</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.TradingProceedsClaimed(address)"></a><code class="function-signature">TradingProceedsClaimed(address sender)</code><span class="function-visibility"></span></h4>
