...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#WethWrapperForAMMExchange.constructor(contract IAMMExchange,contract WETH9)"><code class="function-signature">constructor(contract IAMMExchange _amm, contract WETH9 _weth)</code></a></li><li><a href="#WethWrapperForAMMExchange.addLiquidity()"><code class="function-signature">addLiquidity()</code></a></li><li><a href="#WethWrapperForAMMExchange.addLiquidityThenSwap(bool,uint256)"><code class="function-signature">addLiquidityThenSwap(bool _swapForYes, uint256 _swapHowMuch)</code></a></li><li><a href="#WethWrapperForAMMExchange.removeLiquidity(uint256,uint256)"><code class="function-signature">removeLiquidity(uint256 _poolTokensToSell, uint256 _minSetsSold)</code></a></li><li><a href="#WethWrapperForAMMExchange.enterPosition(bool,uint256)"><code class="function-signature">enterPosition(bool _buyYes, uint256 _minShares)</code></a></li><li><a href="#WethWrapperForAMMExchange.exitPosition(uint256,uint256,uint256,uint256)"><code class="function-signature">exitPosition(uint256 _invalidShares, uint256 _noShares, uint256 _yesShares, uint256 _minCashPayout)</code></a></li><li><a href="#WethWrapperForAMMExchange.exitAll(uint256)"><code class="function-signature">exitAll(uint256 _minCashPayout)</code></a></li></ul></div>
...
<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.addLiquidity()"></a><code class="function-signature">addLiquidity() <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.addLiquidityThenSwap(bool,uint256)"></a><code class="function-signature">addLiquidityThenSwap(bool _swapForYes, uint256 _swapHowMuch) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">external</span></h4>
