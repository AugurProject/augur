...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#IAMMFactory.addAMMWithLiquidity(contract IMarket,contract ParaShareToken,uint256,uint256,uint256,bool,address)"><code class="function-signature">addAMMWithLiquidity(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, uint256 _cash, uint256 _ratioFactor, bool _keepYes, address _recipient)</code></a></li><li><a href="#IAMMFactory.addLiquidity(contract IMarket,contract ParaShareToken,uint256,uint256,address,uint256)"><code class="function-signature">addLiquidity(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, uint256 _cash, address _recipient, uint256 _cashToInvalidPool)</code></a></li><li><a href="#IAMMFactory.salt(contract IMarket,contract ParaShareToken,uint256)"><code class="function-signature">salt(contract IMarket _market, contract ParaShareToken _para, uint256 _fee)</code></a></li><li><a href="#IAMMFactory.transferCash(contract IMarket,contract ParaShareToken,uint256,address,address,uint256)"><code class="function-signature">transferCash(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, address sender, address recipient, uint256 quantity)</code></a></li><li><a href="#IAMMFactory.shareTransfer(contract IMarket,contract ParaShareToken,uint256,address,address,uint256,uint256,uint256)"><code class="function-signature">shareTransfer(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code></a></li></ul></div>
...
<h4><a class="anchor" aria-hidden="true" id="IAMMFactory.addLiquidity(contract IMarket,contract ParaShareToken,uint256,uint256,address,uint256)"></a><code class="function-signature">addLiquidity(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, uint256 _cash, address _recipient, uint256 _cashToInvalidPool) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#IERC20Proxy1155Nexus.newERC20(uint256)"><code class="function-signature">newERC20(uint256 _tokenId)</code></a></li><li><a href="#IERC20Proxy1155Nexus.newERC20s(uint256[])"><code class="function-signature">newERC20s(uint256[] _tokenIds)</code></a></li><li><a href="#IERC20Proxy1155Nexus.transfer(contract IERC20Proxy1155,address,address,uint256)"><code class="function-signature">transfer(contract IERC20Proxy1155 _proxy, address _caller, address _to, uint256 _amount)</code></a></li><li><a href="#IERC20Proxy1155Nexus.transferFrom(contract IERC20Proxy1155,address,address,address,uint256)"><code class="function-signature">transferFrom(contract IERC20Proxy1155 _proxy, address _caller, address _from, address _to, uint256 _amount)</code></a></li><li><a href="#IERC20Proxy1155Nexus.approve(contract IERC20Proxy1155,address,address,uint256)"><code class="function-signature">approve(contract IERC20Proxy1155 _proxy, address _caller, address _spender, uint256 _amount)</code></a></li><li><a href="#IERC20Proxy1155Nexus.allowance(contract IERC20Proxy1155,address,address)"><code class="function-signature">allowance(contract IERC20Proxy1155 _proxy, address _owner, address _spender)</code></a></li></ul></div>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#AMMFactory.constructor(address,contract BFactory,contract IERC20Proxy1155Nexus)"><code class="function-signature">constructor(address _proxyToClone, contract BFactory _bFactory, contract IERC20Proxy1155Nexus _erc20Proxy1155Nexus)</code></a></li><li><a href="#AMMFactory.addLiquidity(contract IMarket,contract ParaShareToken,uint256,uint256,address,uint256)"><code class="function-signature">addLiquidity(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, uint256 _cash, address _recipient, uint256 _cashToInvalidPool)</code></a></li><li><a href="#AMMFactory.addAMMWithLiquidity(contract IMarket,contract ParaShareToken,uint256,uint256,uint256,bool,address)"><code class="function-signature">addAMMWithLiquidity(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, uint256 _cash, uint256 _ratioFactor, bool _keepLong, address _recipient)</code></a></li><li><a href="#AMMFactory.transferCash(contract IMarket,contract ParaShareToken,uint256,address,address,uint256)"><code class="function-signature">transferCash(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, address _sender, address _recipient, uint256 _quantity)</code></a></li><li><a href="#AMMFactory.shareTransfer(contract IMarket,contract ParaShareToken,uint256,address,address,uint256,uint256,uint256)"><code class="function-signature">shareTransfer(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, address _from, address _to, uint256 _invalidAmount, uint256 _noAmount, uint256 _yesAmount)</code></a></li><li><a href="#AMMFactory.claimMarketsProceeds(contract IMarket[],contract IParaShareToken[],address payable,bytes32)"><code class="function-signature">claimMarketsProceeds(contract IMarket[] _markets, contract IParaShareToken[] _shareTokens, address payable _shareHolder, bytes32 _fingerprint)</code></a></li><li><a href="#AMMFactory.calculateAMMAddress(contract IMarket,contract ParaShareToken,uint256)"><code class="function-signature">calculateAMMAddress(contract IMarket _market, contract ParaShareToken _para, uint256 _fee)</code></a></li><li><a href="#AMMFactory.salt(contract IMarket,contract ParaShareToken,uint256)"><code class="function-signature">salt(contract IMarket _market, contract ParaShareToken _para, uint256 _fee)</code></a></li><li class="inherited"><a href="para#CloneFactory2.createClone2(address,uint256)"><code class="function-signature">createClone2(address target, uint256 salt)</code></a></li><li class="inherited"><a href="para#CloneFactory2.clone2Address(address,uint256,address)"><code class="function-signature">clone2Address(address target, uint256 salt, address creator)</code></a></li></ul><span class="contract-index-title">Events</span><ul><li><a href="#AMMFactory.AMMCreated(contract IAMMExchange,contract IMarket,contract ParaShareToken,uint256,contract BPool)"><code class="function-signature">AMMCreated(contract IAMMExchange amm, contract IMarket market, contract ParaShareToken shareToken, uint256 fee, contract BPool bPool)</code></a></li></ul></div>



<h4><a class="anchor" aria-hidden="true" id="AMMFactory.constructor(address,contract BFactory,contract IERC20Proxy1155Nexus)"></a><code class="function-signature">constructor(address _proxyToClone, contract BFactory _bFactory, contract IERC20Proxy1155Nexus _erc20Proxy1155Nexus)</code><span class="function-visibility">public</span></h4>





<h4><a class="anchor" aria-hidden="true" id="AMMFactory.addLiquidity(contract IMarket,contract ParaShareToken,uint256,uint256,address,uint256)"></a><code class="function-signature">addLiquidity(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, uint256 _cash, address _recipient, uint256 _cashToInvalidPool) <span class="return-arrow">→</span> <span class="return-type">uint256</span></code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMFactory.transferCash(contract IMarket,contract ParaShareToken,uint256,address,address,uint256)"></a><code class="function-signature">transferCash(contract IMarket _market, contract ParaShareToken _para, uint256 _fee, address _sender, address _recipient, uint256 _quantity)</code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="AMMFactory.AMMCreated(contract IAMMExchange,contract IMarket,contract ParaShareToken,uint256,contract BPool)"></a><code class="function-signature">AMMCreated(contract IAMMExchange amm, contract IMarket market, contract ParaShareToken shareToken, uint256 fee, contract BPool bPool)</code><span class="function-visibility"></span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="WethWrapperForAMMExchange.constructor(contract IAMMFactory,contract ParaShareToken)"></a><code class="function-signature">constructor(contract IAMMFactory _factory, contract ParaShareToken _shareToken)</code><span class="function-visibility">public</span></h4>
