...
<h4><a class="anchor" aria-hidden="true" id="AMMExchange.EnterPosition(address,uint256,uint256,bool,uint256)"></a><code class="function-signature">EnterPosition(address sender, uint256 cash, uint256 outputShares, bool buyYes, uint256 priorShares)</code><span class="function-visibility"></span></h4>
