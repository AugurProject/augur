...
<h4><a class="anchor" aria-hidden="true" id="ParaShareToken.claimMarketsProceeds(contract IMarket[],address payable,bytes32)"></a><code class="function-signature">claimMarketsProceeds(contract IMarket[] _markets, address payable _shareHolder, bytes32 _fingerprint) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">external</span></h4>
