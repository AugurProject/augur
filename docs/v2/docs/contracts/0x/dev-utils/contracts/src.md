...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#LibTransactionDecoder.decodeZeroExTransactionData(bytes)"><code class="function-signature">decodeZeroExTransactionData(bytes transactionData)</code></a></li></ul></div>



<h4><a class="anchor" aria-hidden="true" id="LibTransactionDecoder.decodeZeroExTransactionData(bytes)"></a><code class="function-signature">decodeZeroExTransactionData(bytes transactionData) <span class="return-arrow">→</span> <span class="return-type">string,struct LibOrder.Order[],uint256[],bytes[]</span></code><span class="function-visibility">public</span></h4>
