...
<h4><a class="anchor" aria-hidden="true" id="Augur.trustedTransfer(address,address,uint256)"></a><code class="function-signature">trustedTransfer(address _from, address _to, uint256 _amount) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">public</span></h4>
