...
<h4><a class="anchor" aria-hidden="true" id="Trade.createWithTotalCost(enum Order.TradeDirections,contract IMarket,uint256,uint256,uint256,bytes32,bytes32,bytes32,uint256,bool,address,address,contract IERC20)"></a><code class="function-signature">createWithTotalCost(enum Order.TradeDirections _direction, contract IMarket _market, uint256 _outcome, uint256 _totalCost, uint256 _price, bytes32 _betterOrderId, bytes32 _worseOrderId, bytes32 _tradeGroupId, uint256 _loopLimit, bool _ignoreShares, address _affiliateAddress, address _sender, contract IERC20 _kycToken) <span class="return-arrow">→</span> <span class="return-type">struct Trade.Data</span></code><span class="function-visibility">internal</span></h4>
