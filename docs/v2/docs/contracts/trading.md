...
<h4><a class="anchor" aria-hidden="true" id="ProfitLoss.recordExternalTransfer(contract IUniverse,contract IMarket,uint256,address,address,uint256)"></a><code class="function-signature">recordExternalTransfer(contract IUniverse _universe, contract IMarket _market, uint256 _outcome, address _source, address _destination, uint256 _value) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">external</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="ShareToken.setUniverse(contract IUniverse)"></a><code class="function-signature">setUniverse(contract IUniverse _universe)</code><span class="function-visibility">external</span></h4>
