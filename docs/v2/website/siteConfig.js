...
const siteConfig = {
  ...
  organizationName: 'Forecast Foundation OU',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Forecast Foundation OU`,
  ...
  repoUrl: 'https://github.com/augurproject',
};
